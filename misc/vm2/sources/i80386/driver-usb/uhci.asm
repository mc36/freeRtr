...
call dword uhci_testChip
mov esi,offset text03
jc dword vege

call dword uhci_resetChip
call dword uhci_setupBufs
call dword uhci_resetChip
call dword uhci_setupChip
...
mov esi,dataSeg_freMem
add esi,4
call dword uhci_beginReceiving
command_receive_j1:
stc
retnd
endp
...
textCRLF db 13,10
textNONE db 0
text01 db 'usb uhci driver v1.0, done by Mc at ',%date,' ',%time,'.',13,10,0
text02 db 'using: uhci.code <port number>',0
...
dataSeg_ioPort equ 0104h        ;dd: base address...
...
dataSeg_freMem equ 1118h        ;free memory...
;-------------------------------
