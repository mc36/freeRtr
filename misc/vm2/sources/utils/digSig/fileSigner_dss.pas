...
Var
  ...
  f:xFile;
BEGIN;
WriteLn('dss file signer v1.0, done by Mc at '#%date' '#%time'.');
Randomize;
...
if (paramStr(3)='') then immErr('using: signDSSfile.exe <key> <file> <signature>');

WriteLn('going to sign file with DSS key...');
