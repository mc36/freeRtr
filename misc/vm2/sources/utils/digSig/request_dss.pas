...
Var
  ...
  t:xtText;
BEGIN;
WriteLn('dss cert requester v1.0, done by Mc at '#%date' '#%time'.');
Randomize;
...
if (paramStr(3)='') then immErr('using: reqDSScert.exe <key> <person> <output>');

WriteLn('going to request DSS certificate...');
