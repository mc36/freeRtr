...
Const proggyName='l2tp server v1.0';
...
a:='12341234'#0#0#0#0#0#0#0#0+chr(ConnectionDat^[o].tuneR)+#255'l2tp with '+a+#0;
...
a:=paramStr(1);
if (a='') then immErr('using: l2tp.code <config>');
ReadUpConfig(a);
