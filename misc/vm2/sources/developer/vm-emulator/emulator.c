...
if (sig) switch (siz) {
  case 1: d=(int8)d; break;
  case 2: d=(int16)d; break;
  case 3: d=(int32)d; break;
  }
if (after) switch (siz) {
  case 1: d&=0xff; break;
  case 2: d&=0xffff; break;
...
if (frm==2) switch (siz) {
  case 1: d&=0xff; break;
  case 2: d=((d>>8)&0xff)|((d<<8)&0xff00); break;
  case 3: d=((d>>24)&0xff)|((d>>8)&0xff00)|((d<<8)&0xff0000)|(d<<24); break;
  }
return d;
}
...
switch (siz1) {
  case 1:  //add
    ...
    if (siz1&0x80) val1=getConstant(d,4); else val1=d->regs[getConstant(d,1)];
    d->regs[reg1]+=val1;
    return 0;
    break;
  case 2:  //sub
  ...
  case 16:  //move
    ...
    reg1=getConstant(d,1);
    if (siz2&0x80) val1=getConstant(d,4); else val1=d->regs[getConstant(d,1)];
  ...
  case 30:  //setc
    ...
    siz1=getConstant(d,1);
    reg1=getConstant(d,1);
    if (d->flags&reg2) val1=1; else val1=0;
    d->regs[reg1]=val1;
    return 0;
    break;
  case 32:  //syscall
