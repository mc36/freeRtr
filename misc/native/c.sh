...
for fn in p4emu_full p4emu_dbg p4emu_nocr p4emu_none p4emu_pcap p4emu_bench p4emu_udp p4emu_uds p4emu_map p4emu_raw p4emu_xsk p4emu_urng; do
  compileLib $fn "" ""
  done
...
linkTwoLibs "p4uds" "p4emu_uds" "p4emu_full" "-lcrypto"
