...
public class renamer {
    ...
    public static String guessName(String s, boolean basic) {
        ...
        if ("|kbps|128|192|256|320|Ep|Lp|Vinyl|Dcd|Cd|Cds|2cd|3cd|4cd|5cd|6cd|7cd|7cd|9cd|Live|Demo|Split|Promo|Bootleg|Single|Version|Edition|Instrumental|Remastered|Rerecorded|Reissue|Re-recorded|Re-mastered|Re-issue|Compilation|Deluxe|Limited|Digipack|".indexOf("|" + a + "|") >= 0) {
