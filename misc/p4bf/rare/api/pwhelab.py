...
def writePwheMplsRules(self, op_type, dst_label, port):
    if self.mpls == False:
        return
    tbl_global_path_1 = "ig_ctl.ig_ctl_mpls"
    tbl_name_1 = "%s.tbl_mpls_fib" % (tbl_global_path_1)
    tbl_action_name_1 = "%s.act_mpls_decap_pwhe" % (tbl_global_path_1)
    ...
    tbl_action_name_2 = "%s.act_mpls_decap_pwhe" % (tbl_global_path_2)
