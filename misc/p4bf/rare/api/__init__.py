...
class RareApi(BfRtRare):
    ...
    from .mgre4 import writeMgre4rules
    from .mgre6 import writeMgre6rules
    ...
    #from .label6 import
    from .vpnlabel4 import writeVpnMplsRules
    #from .vpnlabel6 import
    ...
    from .nshnei import writeNshNeiRules
