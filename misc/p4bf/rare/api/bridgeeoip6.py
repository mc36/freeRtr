...
def writeEoip6rules(
    ...
    sap_type = 4
    tbl_action_name_2 = "%s.act_set_bridge_eoip6" % (tbl_global_path_2)
    key_field_list_2 = [
    ...
    data_field_list_2 = [
        ...
        gc.DataTuple("instance", (instance >> 8) | ((instance & 0xff) << 8))
    ]
    ...
    tbl_action_name_3 = "%s.act_tunnel_eoip" % (tbl_global_path_3)
    key_field_list_3 = [
