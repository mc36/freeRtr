...
def writeEtherip4rules(
    self, op_type, bridge, addr, sip, dip, nexthop, vrf, port
):
    if self.tun == False:
        return
    ...
    sap_type = 4
    tbl_action_name_2 = "%s.act_set_bridge_etherip4" % (tbl_global_path_2)
    key_field_list_2 = [
    ...
    tbl_action_name_3 = "%s.act_tunnel_etherip" % (tbl_global_path_3)
    key_field_list_3 = [
        ...
        gc.KeyTuple("hdr.ipv4.protocol", 97),
    ]
    data_field_list_3 = [
