...
def writeGtp4rules(
    self, op_type, nexthop, port, phport, sip, dip, dmac, vrf, smac, sprt, dprt, teid
):
    if self.tun == False:
        return
    tbl_global_path_1 = "ig_ctl.ig_ctl_tunnel"
    tbl_name_1 = "%s.tbl_tunnel4" % (tbl_global_path_1)
    tbl_action_name_1 = "%s.act_tunnel_gtp" % (tbl_global_path_1)
    key_field_list_1 = [
    ...
    tbl_action_name_2 = "%s.act_ipv4_gtp4" % (tbl_global_path_2)
    key_field_list_2 = [
