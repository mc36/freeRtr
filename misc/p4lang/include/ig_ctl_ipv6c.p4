...
#ifndef _IG_CTL_IPv6c_P4_
#define _IG_CTL_IPv6c_P4_

control IngressControlIPv6c(inout headers hdr,
    ...
    action act_ipv6_cpl_set_mode(bit<2> mod) {
        mode = mod;
    }
    ...
    action act_ipv6_cpl_found(NextHopId_t hop) {
        neigh = hop;
    }

    action act_ipv6_cpl_ours(SubIntId_t subif) {
        port = subif;
    }
