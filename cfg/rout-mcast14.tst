description multicast between pim and pim over bier
...
int eth2 eth 0000.0000.4444 $5a$ $5b$
!
vrf def v1
 rd 1:1
 label-mode per-prefix
...
r5 tping 100 20 2.2.2.11 /vrf v1 /int eth1
r5 tping 100 20 4321::11 /vrf v1 /int eth1
r5 tping 100 20 2.2.2.14 /vrf v1 /int eth1
r5 tping 100 20 4321::14 /vrf v1 /int eth1

r6 tping 100 20 2.2.2.11 /vrf v1 /int eth1
r6 tping 100 20 4321::11 /vrf v1 /int eth1
r6 tping 100 20 2.2.2.14 /vrf v1 /int eth1
