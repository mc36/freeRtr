description egress multicast routing ttl treshold
...
int eth2
 ...
 ipv4 multi static 232.2.2.2 1.1.1.1
 ipv6 multi static ff06::1 1234:1::1
 ipv4 multi ttl-threshold-out 123
 ipv6 multi ttl-threshold-out 123
 exit
!
...
r1 tping 100 60 232.2.2.2 vrf v1 sou eth1 ttl 150
r1 tping 100 60 ff06::1 vrf v1 sou eth1 ttl 150

r1 tping 0 60 232.2.2.2 vrf v1 sou eth1 ttl 50
r1 tping 0 60 ff06::1 vrf v1 sou eth1 ttl 50
