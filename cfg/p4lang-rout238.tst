description p4lang: route filtering with prefixlist
...
int sdn4
 ...
 exit
prefix-list p4
 sequence 10 deny 2.2.2.104/32
 sequence 20 permit 0.0.0.0/0 le 32
 exit
prefix-list p6
 sequence 10 deny 4321::104/128
...
r3 tping 0 10 2.2.2.104 vrf v1 sou lo0
r3 tping 0 10 4321::104 vrf v1 sou lo0
...
r4 tping 0 10 2.2.2.103 vrf v1 sou lo0
r4 tping 0 10 4321::103 vrf v1 sou lo0
