description p4lang: routing over ipv6 backplane
...
server stack s
 dataplanes 4
 label-base 200
 advert-base 1234:7::0
 forwarder 1 p4lang a
 forwarder 1 backroute bun1 1 1234:8::2 1
 forwarder 1 remote 10.11.12.111
 forwarder 2 p4lang b
 forwarder 2 backroute bun2 1 1234:9::2 2
...
int eth2 eth 0000.0000.4444 $6b$ $6a$
int eth3 eth 0000.0000.4444 $11b$ $11a$
int eth4 eth 0000.0000.4444 $12b$ $12a$
!
vrf def v1
