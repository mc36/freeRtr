description p4lang: l3vpn over pwhe mpls
...
r7 tping 100 60 9.9.2.2 vrf v2
r5 tping 100 60 9.9.2.1 vrf v2
r7 tping 100 60 9992::2 vrf v2
r5 tping 100 60 9992::1 vrf v2

r7 tping 100 60 9.9.3.2 vrf v3
r5 tping 100 60 9.9.3.1 vrf v3
r7 tping 100 60 9993::2 vrf v3
r5 tping 100 60 9993::1 vrf v3

r7 tping 100 60 9.9.4.2 vrf v4
r5 tping 100 60 9.9.4.1 vrf v4
r7 tping 100 60 9994::2 vrf v4
r5 tping 100 60 9994::1 vrf v4

r1 dping sdn . r7 9.9.3.2 vrf v3
r1 dping sdn . r7 9993::2 vrf v3
