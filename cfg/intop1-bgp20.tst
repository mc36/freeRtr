description interop1: bgp with php labels
...
r3 tping 0 120 2.2.2.2 vrf v1 int lo0
!r3 tping 0 120 4321::2 vrf v1 int lo0

r1 tping 0 120 2.2.2.3 vrf v1 int lo0
!r1 tping 0 120 4321::3 vrf v1 int lo0
r3 tping 0 120 2.2.2.1 vrf v1 int lo0
!r3 tping 0 120 4321::1 vrf v1 int lo0
