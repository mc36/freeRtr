description otherl3evpns egress route filtering with routemap with soft-reconfig
...
route-map p4
 sequence 10 act deny
  match network 9.9.2.11/32
 sequence 20 act deny
  match network 9.9.3.11/32
 sequence 30 act deny
  match network 9.9.4.11/32
 sequence 40 act perm
  match network 0.0.0.0/0 le 32
 exit
route-map p6
 sequence 10 act deny
  match network 9992::11/128
 sequence 20 act deny
  match network 9993::11/128
 sequence 30 act deny
  match network 9994::11/128
 sequence 40 act perm
...
router bgp4 1
 ...
 neigh 2.2.2.2 evpn-route-map-out p6
 afi-ol3e v2 ena
...
router bgp6 1
 ...
 neigh 4321::2 evpn-route-map-out p4
 afi-ol3e v2 ena
 afi-ol3e v2 red conn
 afi-ol3e v3 ena
 afi-ol3e v3 red conn
...
r2 tping 0 60 9.9.2.11 vrf v2
r1 tping 100 60 9992::22 vrf v2
r2 tping 0 60 9992::11 vrf v2

r1 tping 100 60 9.9.3.22 vrf v3
r2 tping 0 60 9.9.3.11 vrf v3
r1 tping 100 60 9993::22 vrf v3
r2 tping 0 60 9993::11 vrf v3

r1 tping 100 60 9.9.4.22 vrf v4
r2 tping 0 60 9.9.4.11 vrf v4
r1 tping 100 60 9994::22 vrf v4
r2 tping 0 60 9994::11 vrf v4
