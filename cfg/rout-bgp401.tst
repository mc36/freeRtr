description ibgp with php labels
...
r2 tping 0 60 2.2.2.11 vrf v1 int lo0
r2 tping 0 60 2.2.2.13 vrf v1 int lo0
r2 tping 0 60 4321::11 vrf v1 int lo0
r2 tping 0 60 4321::13 vrf v1 int lo0
