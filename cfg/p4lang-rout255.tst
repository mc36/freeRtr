description p4lang: bridging over l2tp3
...
int virt1
 enc ppp
 pseudo v2 sdn3 l2tp3 9.9.9.2 1234
 bridge-gr 1
 vrf for v8
...
addother r2 controller r1 v9 9080 - feature bridge l3tp l3tptap
...
int virt1
 enc ppp
 pseudo v2 eth1 l2tp3 9.9.9.1 1234
 bridge-gr 1
 exit
int bvi1
 vrf for v1
