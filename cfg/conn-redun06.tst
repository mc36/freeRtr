description pppoe client with process redundancy
...
r1 tping 100 30 1.1.1.3 vrf v1
r1 tping 100 30 1234::3 vrf v1
...
r1 tping 100 30 1.1.1.3 vrf v1
r1 tping 100 30 1234::3 vrf v1
r4 tping 100 30 1.1.1.1 vrf v1
r4 tping 100 30 1234::1 vrf v1
