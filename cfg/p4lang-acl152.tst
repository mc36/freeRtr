description p4lang: pppoe over pwhe interface loose verify source
...
addother r2 controller r1 v9 9080 - feature pppwhe vrfysrc
...
int eth1
 ...
 exit
int pweth1
 pseudowire v2 lo2 pweompls 8.8.8.1 1234
 p2poe relay di1
 exit
int eth2
 vrf for v1
