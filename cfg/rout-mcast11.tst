...
ipv6 multi v1 join ff33::1 1234:1::1
!

r2 tping 100 3 1.1.1.9 /vrf v1
r2 tping 100 3 1.1.1.5 /vrf v1
r2 tping 100 3 1.1.1.1 /vrf v1
r2 tping 100 3 1234:3::1 /vrf v1
r2 tping 100 3 1234:2::1 /vrf v1
r2 tping 100 3 1234:1::1 /vrf v1

r1 tping 100 3 1.1.1.5 /vrf v1
r1 tping 100 3 1234:2::1 /vrf v1
r1 tping 100 3 1.1.1.9 /vrf v1
r1 tping 100 3 1234:3::1 /vrf v1

r3 tping 100 3 1.1.1.1 /vrf v1
r3 tping 100 3 1234:1::1 /vrf v1

r1 tping 100 3 232.2.2.2 /vrf v1 /int eth1
r1 tping 100 3 ff33::1 /vrf v1 /int eth1
