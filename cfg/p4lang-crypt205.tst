description p4lang: flow inspection
...
ipv4 flow v1 coll
ipv6 flow v1 coll
ipv4 flow v1 param sample 111
ipv6 flow v1 param sample 111
vrf def v9
 rd 1:1
 exit
int lo9
...
r1 output show ipv4 flow v1 toptalk
r1 output show ipv6 flow v1 toptalk
