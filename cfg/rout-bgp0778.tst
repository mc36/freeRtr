description unicast+vpns over confed bgp with dynamic capability
...
r1 send clear ipv4 bgp 1 peer 2.2.2.2 del vpnuni
r1 send clear ipv6 bgp 1 peer 4321::2 del vpnuni
...
r1 send clear ipv4 bgp 1 peer 2.2.2.2 add vpnuni
r1 send clear ipv6 bgp 1 peer 4321::2 add vpnuni
