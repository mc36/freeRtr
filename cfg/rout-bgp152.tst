description unicast+vpns over bgp additional path
...
router bgp4 1
 ...
 neigh 2.2.2.2 additional-path-rx vpnuni uni
 neigh 2.2.2.2 additional-path-tx vpnuni uni
 red conn
 afi-vrf v2 ena
 afi-vrf v2 red conn
 afi-vrf v3 ena
...
router bgp6 1
 ...
 neigh 4321::2 additional-path-rx vpnuni uni
 neigh 4321::2 additional-path-tx vpnuni uni
 red conn
 afi-vrf v2 ena
 afi-vrf v2 red conn
 afi-vrf v3 ena
...
router bgp4 1
 ...
 neigh 2.2.2.1 additional-path-rx vpnuni uni
 neigh 2.2.2.1 additional-path-tx vpnuni uni
 red conn
 afi-vrf v2 ena
 afi-vrf v2 red conn
 afi-vrf v3 ena
...
router bgp6 1
 ...
 neigh 4321::1 additional-path-rx vpnuni uni
 neigh 4321::1 additional-path-tx vpnuni uni
 red conn
 afi-vrf v2 ena
 afi-vrf v2 red conn
 afi-vrf v3 ena
