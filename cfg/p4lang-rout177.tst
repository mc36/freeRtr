description p4lang: policy routing to p2p te over mpls
...
r1 tping 100 10 1.1.1.2 vrf v1 int sdn1
r1 tping 100 10 1234:1::2 vrf v1 int sdn1
r1 tping 100 10 1.1.2.2 vrf v1 int sdn2
r1 tping 100 10 1234:2::2 vrf v1 int sdn2
r1 tping 100 10 1.1.3.2 vrf v1 int sdn3
r1 tping 100 10 1234:3::2 vrf v1 int sdn3
r1 tping 100 10 1.1.4.2 vrf v1 int sdn4
r1 tping 100 10 1234:4::2 vrf v1 int sdn4

r3 tping 100 10 1.1.1.2 vrf v1 int eth1
r3 tping 100 10 1234:1::2 vrf v1 int eth1
r3 tping 100 10 1.1.2.2 vrf v1 int eth1
r3 tping 100 10 1234:2::2 vrf v1 int eth1
r3 tping 100 10 1.1.3.2 vrf v1 int eth1
r3 tping 100 10 1234:3::2 vrf v1 int eth1
r3 tping 100 10 1.1.4.2 vrf v1 int eth1
r3 tping 100 10 1234:4::2 vrf v1 int eth1

r4 tping 100 10 1.1.1.2 vrf v1 int eth1
r4 tping 100 10 1234:1::2 vrf v1 int eth1
r4 tping 100 10 1.1.2.2 vrf v1 int eth1
r4 tping 100 10 1234:2::2 vrf v1 int eth1
r4 tping 100 10 1.1.3.2 vrf v1 int eth1
r4 tping 100 10 1234:3::2 vrf v1 int eth1
r4 tping 100 10 1.1.4.2 vrf v1 int eth1
r4 tping 100 10 1234:4::2 vrf v1 int eth1

r5 tping 100 10 1.1.1.2 vrf v1 int eth1
r5 tping 100 10 1234:1::2 vrf v1 int eth1
r5 tping 100 10 1.1.2.2 vrf v1 int eth1
r5 tping 100 10 1234:2::2 vrf v1 int eth1
r5 tping 100 10 1.1.3.2 vrf v1 int eth1
r5 tping 100 10 1234:3::2 vrf v1 int eth1
r5 tping 100 10 1.1.4.2 vrf v1 int eth1
r5 tping 100 10 1234:4::2 vrf v1 int eth1

r6 tping 100 10 1.1.1.2 vrf v1 int eth1
r6 tping 100 10 1234:1::2 vrf v1 int eth1
r6 tping 100 10 1.1.2.2 vrf v1 int eth1
r6 tping 100 10 1234:2::2 vrf v1 int eth1
r6 tping 100 10 1.1.3.2 vrf v1 int eth1
r6 tping 100 10 1234:3::2 vrf v1 int eth1
r6 tping 100 10 1.1.4.2 vrf v1 int eth1
r6 tping 100 10 1234:4::2 vrf v1 int eth1
...
r1 tping 100 10 2.2.2.203 vrf v1 int lo0
r1 tping 100 10 4321::203 vrf v1 int lo0
...
r3 tping 100 10 2.2.2.203 vrf v1 int lo0
r3 tping 100 10 4321::203 vrf v1 int lo0
...
r4 tping 100 10 2.2.2.203 vrf v1 int lo0
r4 tping 100 10 4321::203 vrf v1 int lo0
...
r5 tping 100 10 2.2.2.203 vrf v1 int lo0
r5 tping 100 10 4321::203 vrf v1 int lo0
...
r6 tping 100 10 2.2.2.203 vrf v1 int lo0
r6 tping 100 10 4321::203 vrf v1 int lo0

r1 dping sdn . r6 2.2.2.203 vrf v1 int lo0
r1 dping sdn . r6 4321::203 vrf v1 int lo0
