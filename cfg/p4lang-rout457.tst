description p4lang: mgre routing over ipv4 loopback
...
int sdn1
 ...
 ipv4 multi static 232.2.2.2 8.8.8.1
 exit
int tun1
 tun vrf v2
 tun source lo1
...
ipv4 mroute v2 8.8.8.2 255.255.255.255 9.9.9.2
...
int bvi1
 ...
 ipv4 multi static 232.2.2.2 8.8.8.2
 exit
int tun1
 tun vrf v2
 tun source lo1
...
ipv4 mroute v2 8.8.8.1 255.255.255.255 9.9.9.1
