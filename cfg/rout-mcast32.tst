description multicast routing with egress msdp override
...
router msdp4 1
 ...
 adv-sa 232.2.2.2 1.1.1.1 1.1.1.0
 exit
router msdp6 1
 vrf v1
...
int eth1
 ...
 ipv6 multi host-ena
 ipv6 multi host-pro
 ipv4 multicast source-lookup-out msdp4 1
 ipv6 multicast source-lookup-out msdp6 1
 exit
int eth2
 vrf for v1
