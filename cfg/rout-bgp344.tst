description bgp vpn with import map
...
vrf def v1
 ...
 exit
route-map rm4
 match network 3.3.3.0/24 ge 32 le 32
 exit
route-map rm6
 match network 3333::/64 ge 128 le 128
 exit
vrf def v3
 rd 1:3
 rt-both 1:3
...
r2 tping 0 60 3.3.3.1 /vrf v3 /int lo3
r2 tping 0 60 3333::1 /vrf v3 /int lo3
r2 tping 100 60 3.3.3.3 /vrf v3 /int lo3
r2 tping 100 60 3333::3 /vrf v3 /int lo3
