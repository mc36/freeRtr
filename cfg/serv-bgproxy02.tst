...
router bgp4 1
 ...
 neigh 1.1.1.3 proxy p1 1.1.1.3 179
 red conn
 exit
router bgp6 1
 vrf v1
 ...
 neigh 1234::3 proxy p1 1234::3 179
 red conn
 exit
!
...
r2 tping 100 60 1.1.1.3 vrf v1
r2 tping 100 60 1234::3 vrf v1
...
r1 send neigh 1.1.1.3 shut
r1 send exit
r1 send router bgp6 1
r1 send neigh 1234::3 shut
r1 send end
