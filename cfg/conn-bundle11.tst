description multichassis bundle
...
int eth1 eth 0000.0000.2222 $3a$ $3b$
!
vrf def v1
 rd 1:1
 exit
...
int eth1 eth 0000.0000.2222 $3b$ $3a$
!
vrf def v1
 rd 1:1
 exit
...
r1 tping 100 3 2.2.2.1 /vrf v1
r1 tping 100 3 4321::1 /vrf v1
r1 send exit
r1 read closed
