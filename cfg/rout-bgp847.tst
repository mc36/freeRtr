description otherl3evpns egress route filtering with routepolicy with soft-reconfig
...
route-policy p4
 if network 9.9.2.11/32
  drop
 enif
 if network 9.9.3.11/32
  drop
 enif
 if network 9.9.4.11/32
  drop
 enif
 ...
 exit
route-policy p6
 if network 9992::11/128
  drop
 enif
 if network 9993::11/128
  drop
 enif
 if network 9994::11/128
  drop
 enif
 if network ::/0 le 128
  pass
...
router bgp4 1
 ...
 neigh 2.2.2.2 evpn-route-policy-out p6
 afi-ol3e v2 ena
...
router bgp6 1
 ...
 neigh 4321::2 evpn-route-policy-out p4
 afi-ol3e v2 ena
 afi-ol3e v2 red conn
 afi-ol3e v3 ena
 afi-ol3e v3 red conn
