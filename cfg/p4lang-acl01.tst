...
int lo0
 ...
 exit
access-list test4
 deny 1 2.2.2.104 255.255.255.255 0 2.2.2.101 255.255.255.255 0
 permit all any all any all
 exit
access-list test6
 deny 58 4321::104 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff 0 4321::101 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff 0
 permit all any all any all
 exit
int sdn1
 vrf for v1
