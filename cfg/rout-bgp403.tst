description ibgp rr with labels
...
r1 tping 100 60 2.2.2.12 vrf v1 int lo0
r1 tping 100 60 4321::12 vrf v1 int lo0
r1 tping 100 60 2.2.2.13 vrf v1 int lo0
r1 tping 100 60 4321::13 vrf v1 int lo0
...
r2 tping 100 60 2.2.2.11 vrf v1 int lo0
r2 tping 100 60 2.2.2.13 vrf v1 int lo0
r2 tping 100 60 4321::11 vrf v1 int lo0
r2 tping 100 60 4321::13 vrf v1 int lo0
...
r3 tping 100 60 2.2.2.11 vrf v1 int lo0
r3 tping 100 60 4321::11 vrf v1 int lo0
r3 tping 100 60 2.2.2.12 vrf v1 int lo0
r3 tping 100 60 4321::12 vrf v1 int lo0
