description static labels over ibgp rr mpns
...
ipv4 route v1 2.2.2.104 255.255.255.255 1.1.1.10
ipv6 route v1 4321::104 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff 1234:3::2
...
ipv4 route v1 2.2.2.102 255.255.255.255 1.1.1.13
ipv6 route v1 4321::102 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff 1234:4::1
ipv4 route v1 2.2.2.103 255.255.255.255 1.1.1.13
ipv6 route v1 4321::103 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff 1234:4::1
ipv4 route v1 2.2.2.105 255.255.255.255 1.1.1.5 mplsval 504
ipv6 route v1 4321::105 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff 1234:2::1 mplsval 506
!
...
r2 tping 100 60 2.2.2.104 vrf v1 sou lo0
r2 tping 100 60 4321::104 vrf v1 sou lo0
r4 tping 100 60 2.2.2.102 vrf v1 sou lo0
r4 tping 100 60 4321::102 vrf v1 sou lo0

r2 tping 100 60 2.2.2.101 vrf v1 sou lo0
r2 tping 100 60 4321::101 vrf v1 sou lo0
r4 tping 100 60 2.2.2.105 vrf v1 sou lo0
r4 tping 100 60 4321::105 vrf v1 sou lo0
