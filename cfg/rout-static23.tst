...
int eth1
 ...
 exit
ipv4 route v1 0.0.0.0 0.0.0.0 1234:1::2
...
int eth2
 ...
 exit
ipv4 route v1 2.2.2.101 255.255.255.255 1234:1::1
ipv6 route v1 4321::101 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff 1234:1::1
ipv4 route v1 2.2.2.201 255.255.255.255 1234:2::1
...
int eth1
 ...
 exit
ipv4 route v1 0.0.0.0 0.0.0.0 1234:2::2
