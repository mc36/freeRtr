description bgp additional path with php labels
...
r2 tping 0 60 2.2.2.1 vrf v1 int lo0
r2 tping 0 60 2.2.2.3 vrf v1 int lo0
r2 tping 0 60 4321::3 vrf v1 int lo0
r2 tping 0 60 4321::1 vrf v1 int lo0
