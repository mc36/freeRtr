description ingress mpls common access list
...
r1 tping 100 10 2.2.2.201 vrf v1 int lo0
r1 tping 100 10 4321::201 vrf v1 int lo0
r1 tping 0 10 2.2.2.201 vrf v1 int lo1
r1 tping 0 10 4321::201 vrf v1 int lo1
