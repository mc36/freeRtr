description p4lang: mgre routing over ipv6 loopback
...
int sdn1
 ...
 ipv6 ena
 ipv6 multi static ff06::2 8888::1
 exit
int tun1
 tun vrf v2
 tun source lo1
 tun domain 8888::2
 tun destination ff06::2
 tun mode mgre
 vrf for v1
...
ipv6 mroute v2 8888::2 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff 9999::2
...
addother r2 controller r1 v9 9080 - feature mgre route mroute
...
int bvi1
 ...
 ipv6 multi static ff06::2 8888::2
 exit
int tun1
 tun vrf v2
 tun source lo1
...
ipv6 mroute v2 8888::1 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff 9999::1
