description policy routing with interface and nexthop between vrfs
...
r1 tping 100 3 2.2.2.201 /vrf v1 /int lo0
r1 tping 100 3 4321::201 /vrf v1 /int lo0
r3 tping 100 3 2.2.2.101 /vrf v1 /int lo0
r3 tping 100 3 4321::101 /vrf v1 /int lo0

r1 tping 0 3 2.2.2.201 /vrf v1
r1 tping 0 3 4321::201 /vrf v1
r3 tping 0 3 2.2.2.101 /vrf v1
r3 tping 0 3 4321::101 /vrf v1
