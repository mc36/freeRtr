description bgp change in destination prefer with soft-reconfig
...
route-map rm1
 ...
 sequence 10 match destpref 5000
...
router bgp4 1
 ...
 neigh 1.1.1.1 destination-prefer
...
router bgp6 1
 ...
 neigh 1234:1::1 destination-prefer
...
route-map rm1
 sequence 10 act deny
 sequence 10 match destpref 3000
 sequence 20 act perm
 exit
router bgp4 1
 vrf v1
