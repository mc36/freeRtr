description p4lang: mgre routing over hairpin qinq
...
int hair12.111.222
 ...
 ipv4 multi static 232.2.2.2 9.9.8.2
 exit
int sdn1
 vrf for v3
...
ipv4 mroute v2 9.9.8.0 255.255.255.0 9.9.9.2
int tun1
 tun vrf v2
 tun source hair11.111.222
 tun domain 9.9.8.2
...
addother r2 controller r1 v9 9080 - feature mgre route vlan hairpin mroute
...
ipv4 mroute v2 9.9.9.0 255.255.255.0 9.9.8.1
