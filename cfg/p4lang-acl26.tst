description p4lang: hairpin vlan pppoe egress access list
...
addother r2 controller r1 v9 9080 - feature acl hairpin pppoe vlan
...
r1 tping 100 30 1.1.1.2 vrf v2
r1 tping 100 30 1234:1::2 vrf v2
r1 tping 100 30 1.1.2.2 vrf v2
r1 tping 100 30 1234:2::2 vrf v2
r1 tping 100 30 1.1.3.2 vrf v2
r1 tping 100 30 1234:3::2 vrf v2
r1 tping 100 30 1.1.4.2 vrf v2
r1 tping 100 30 1234:4::2 vrf v2
...
r1 tping 100 10 2.2.2.100 vrf v1 sou lo0
r1 tping 100 10 4321::100 vrf v1 sou lo0
...
r1 tping 100 10 2.2.2.100 vrf v2 sou lo1
r1 tping 100 10 4321::100 vrf v2 sou lo1
r1 tping 100 10 2.2.2.101 vrf v2 sou lo1
r1 tping 100 10 4321::101 vrf v2 sou lo1
...
r6 tping 0 10 2.2.2.104 vrf v1 sou lo0
r6 tping 0 10 4321::104 vrf v1 sou lo0
