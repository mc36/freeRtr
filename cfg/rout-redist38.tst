description redistribution filtering with accesslist in routepolicy
...
vrf def v1
 ...
 exit
access-list p4
 deny all 2.2.2.8 255.255.255.248 all 0.0.0.0 0.0.0.0 all
 permit all any all any all
 exit
access-list p6
 deny all 4321::10 ffff:ffff:ffff:ffff:ffff:ffff:ffff:fff0 all :: :: all
 permit all any all any all
 exit
route-policy h4
 if access-list p4
