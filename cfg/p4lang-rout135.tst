description p4lang: policy routing with interface and nexthop
...
r3 tping 0 10 1234:3::2 /vrf v1
r3 tping 0 10 1.1.4.2 /vrf v1
r3 tping 0 10 1234:4::2 /vrf v1

r4 tping 0 10 1.1.1.2 /vrf v1
r4 tping 0 10 1234:1::2 /vrf v1
...
r5 tping 0 10 1.1.1.2 /vrf v1
r5 tping 0 10 1234:1::2 /vrf v1
...
r1 dping sdn . 10 0-500000 r3 90-100 2.2.2.105 /vrf v1 /int lo0 /siz 1111 /rep 1111
r1 dping sdn . 10 0-500000 r3 90-100 4321::105 /vrf v1 /int lo0 /siz 1111 /rep 1111
