description multicast routing with egress bgp mtree override
...
int eth1
 ...
 ipv6 multi host-ena
 ipv6 multi host-pro
 ipv4 multicast source-lookup-out bgp4 1
 ipv6 multicast source-lookup-out bgp6 1
 exit
int eth2
 vrf for v1
