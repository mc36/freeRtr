description recursive static routing with labels
...
r2 tping 100 5 2.2.2.202 vrf v1 int lo1
r2 tping 100 5 2.2.2.102 vrf v1 int lo1
r2 tping 100 5 4321::202 vrf v1 int lo1
r2 tping 100 5 4321::102 vrf v1 int lo1
r1 tping 100 5 2.2.2.202 vrf v1 int lo1
r1 tping 100 5 4321::202 vrf v1 int lo1
r3 tping 100 5 2.2.2.102 vrf v1 int lo1
r3 tping 100 5 4321::102 vrf v1 int lo1
