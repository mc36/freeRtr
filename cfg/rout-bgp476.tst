description othervpns egress route filtering with routepolicy with soft-reconfig
...
router bgp4 1
 ...
 neigh 2.2.2.2 ovpn-route-policy-out p6
 afi-ovrf v2 ena
...
router bgp6 1
 ...
 neigh 4321::2 ovpn-route-policy-out p4
 afi-ovrf v2 ena
 afi-ovrf v2 red conn
 afi-ovrf v3 ena
 afi-ovrf v3 red conn
