...
router bgp4 1
 ...
 neigh 1.1.1.5 leak-role cust
 neigh 1.1.1.10 remote-as 4
 neigh 1.1.1.10 leak-role cust
 red conn
 exit
router bgp6 1
 vrf v1
 ...
 neigh 1234:2::1 leak-role cust
 neigh 1234:3::2 remote-as 4
 neigh 1234:3::2 leak-role cust
 red conn
 exit
!
