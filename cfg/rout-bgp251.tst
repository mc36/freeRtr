description othervpns over ebgp
...
r1 output show ipv4 bgp 1 ovpnuni dat
r1 output show ipv6 bgp 1 ovpnuni dat
r1 output show ipv4 route v1
r1 output show ipv6 route v1
r1 output show ipv4 route v2
r1 output show ipv6 route v2
r1 output show ipv4 route v3
r1 output show ipv6 route v3
r1 output show ipv4 route v4
r1 output show ipv6 route v4
output ../binTmp/rout-bgp-othervpn.html
