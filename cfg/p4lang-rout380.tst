description p4lang: pwhe routing over hairpin
...
server p4lang p4
 ...
 vrf v9
 exit
ipv4 route v2 9.9.9.0 255.255.255.0 9.9.8.2
ipv4 route v2 8.8.8.2 255.255.255.255 9.9.8.2
ipv4 route v3 8.8.8.1 255.255.255.255 9.9.8.1
ipv4 route v3 8.8.8.2 255.255.255.255 9.9.9.2
...
addother r2 controller r1 v9 9080 - feature mpls pwhe route hairpin
...
int bvi2
 ...
 exit
ipv4 route v2 9.9.8.0 255.255.255.0 9.9.9.1
