description p4lang: reflexive access list
...
int pweth1
 ...
 pseudo v1 lo0 pckoudp 2.2.2.104 2554
 exit
int pweth2
 vrf for v1
 ipv4 addr 3.3.2.1 255.255.255.0
 pseudo v1 lo0 pckoudp 4321::104 2554
 exit
...
int pweth1
 ...
 pseudo v1 lo0 pckoudp 2.2.2.103 2554
 exit
int pweth2
 vrf for v1
 ipv4 addr 3.3.2.2 255.255.255.0
 pseudo v1 lo0 pckoudp 4321::103 2554
 exit
...
r1 tping 0 10 1.1.2.2 /vrf v1
r1 tping 0 10 1234:2::2 /vrf v1
...
r5 tping 0 10 1.1.2.2 /vrf v1
r5 tping 0 10 1234:2::2 /vrf v1
...
r6 tping 0 10 1.1.2.2 /vrf v1
r6 tping 0 10 1234:2::2 /vrf v1
...
r1 tping 0 10 2.2.2.104 /vrf v1 /int lo0
r1 tping 0 10 4321::104 /vrf v1 /int lo0
...
r3 tping 0 10 2.2.2.104 /vrf v1 /int lo0
r3 tping 0 10 4321::104 /vrf v1 /int lo0
