description static labels over ibgp rr mpvs
...
router bgp4 1
 ...
 local-as 1
 router-id 4.4.4.2
 neigh 2.2.2.203 remote-as 1
 neigh 2.2.2.203 update lo0
 neigh 2.2.2.203 send-comm both
 afi-vrf v2 ena
 afi-vrf v2 red conn
...
router bgp6 1
 ...
 local-as 1
 router-id 6.6.6.2
 neigh 4321::203 remote-as 1
 neigh 4321::203 update lo0
 neigh 4321::203 send-comm both
 afi-vrf v2 ena
 afi-vrf v2 red conn
 afi-vrf v2 mpns-advert
 afi-vrf v2 mpns-install
