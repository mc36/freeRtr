description p4lang: pppoe over pwhe interface inspection with egress drop
...
addother r2 controller r1 v9 9080 - feature pppwhe inspect
...
r6 tping 100 10 9.9.9.1 vrf v2
r1 tping 100 10 8.8.8.2 vrf v2
r6 tping 100 10 8.8.8.1 vrf v2
...
r6 tping 100 10 3.3.1.1 vrf v1
r6 tping 100 10 3.3.2.1 vrf v1
r3 tping 100 10 3.3.1.2 vrf v1
r3 tping 100 10 3.3.2.2 vrf v1

r1 dping sdn . r6 3.3.1.1 vrf v1
r1 dping sdn . r6 3.3.2.1 vrf v1
