description p4lang: l2vpn over mgre mpls
...
int sdn1
 ...
 ipv4 multi static 232.2.2.2 9.9.9.1
 exit
int tun1
 tun vrf v2
 tun source sdn1
 tun domain 9.9.9.2
 tun destination 232.2.2.2
 tun mode mgre
 vrf for v1
...
addother r2 controller r1 v9 9080 - feature mgre mpls mroute
...
int bvi1
 ...
 ipv4 multi static 232.2.2.2 9.9.9.2
 exit
int tun1
 tun vrf v2
 tun source bvi1
