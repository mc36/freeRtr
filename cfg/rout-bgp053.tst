description bgp additional path
...
router bgp6 1
 ...
 neigh 1234:1::2 additional-path-tx all
 red conn
 exit
!
...
router bgp4 1
 ...
 neigh 1.1.1.1 additional-path-rx all
 neigh 1.1.1.6 remote-as 3
 neigh 1.1.1.6 additional-path-rx all
 red conn
 exit
router bgp6 1
 vrf v1
 ...
 neigh 1234:1::1 additional-path-rx all
 neigh 1234:2::2 remote-as 3
 neigh 1234:2::2 additional-path-rx all
 red conn
 exit
!
...
router bgp4 1
 ...
 neigh 1.1.1.5 additional-path-rx all
 neigh 1.1.1.5 additional-path-tx all
 neigh 1.1.1.10 remote-as 4
 neigh 1.1.1.10 additional-path-rx all
 neigh 1.1.1.10 additional-path-tx all
 red conn
 exit
router bgp6 1
 vrf v1
 ...
 neigh 1234:2::1 additional-path-rx all
 neigh 1234:2::1 additional-path-tx all
 neigh 1234:3::2 remote-as 4
 neigh 1234:3::2 additional-path-rx all
 neigh 1234:3::2 additional-path-tx all
 red conn
 exit
!
...
router bgp4 1
 ...
 neigh 1.1.1.9 additional-path-rx all
 neigh 1.1.1.9 additional-path-tx all
 red conn
 exit
router bgp6 1
 vrf v1
 ...
 neigh 1234:3::1 additional-path-rx all
 neigh 1234:3::1 additional-path-tx all
 red conn
 exit
!
