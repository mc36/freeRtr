description ebgp with strict bfd
...
router bgp4 1
 ...
 neigh 1.1.1.1 bfd-trigger strict
 neigh 1.1.1.5 remote-as 1
 neigh 1.1.1.5 bfd-trigger strict
 red conn
 exit
router bgp6 1
 vrf v1
 ...
 neigh 1234:1::1 bfd-trigger strict
 neigh 1234:2::1 remote-as 1
 neigh 1234:2::1 bfd-trigger strict
 red conn
 exit
!
