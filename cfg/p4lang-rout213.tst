description p4lang: mpls core over backplane
...
vrf def v2
 exit
int pweth1
 pseudo v1 lo0 pweompls 2.2.2.106 1234
 vrf for v2
 ipv4 addr 4.4.4.1 255.255.255.0
 ipv6 addr 4444::1 ffff::
 exit
int pweth2
 pseudo v1 lo0 pweompls 4321::106 1234
 vrf for v2
...
r5 tping 100 10 4.4.4.2 vrf v2
r5 tping 100 10 4.4.6.2 vrf v2
r5 tping 100 10 4444::2 vrf v2
r5 tping 100 10 4446::2 vrf v2

r8 tping 100 10 4.4.4.1 vrf v2
r8 tping 100 10 4.4.6.1 vrf v2
r8 tping 100 10 4444::1 vrf v2
r8 tping 100 10 4446::1 vrf v2

r1 dping sdn . r8 4.4.4.1 vrf v2
r1 dping sdn . r8 4446::1 vrf v2
