description bgp change in large community with soft-reconfig
...
r3 send set lrgcomm 1:1234:3000
r3 send end
...
r3 send conf t
r3 send route-map rm1
r3 send set lrgcomm 1:1234:5000
r3 send end
r3 send clear ipv4 route v1
r3 send clear ipv6 route v1
...
r3 send conf t
r3 send route-map rm1
r3 send set lrgcomm 1:1234:1000
r3 send end
r3 send clear ipv4 route v1
r3 send clear ipv6 route v1
