description p4lang: othervpn mldp vlan egress edge
...
ipv4 route v2 2.2.2.104 255.255.255.255 1.1.2.2
ipv4 route v2 2.2.2.105 255.255.255.255 1.1.3.2
ipv4 route v1 2.2.2.206 255.255.255.255 1.1.4.2
ipv6 route v2 4321::103 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff 1234:1::2
ipv6 route v2 4321::104 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff 1234:2::2
ipv6 route v2 4321::105 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff 1234:3::2
ipv6 route v1 4321::206 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff 1234:4::2
router bgp4 1
 vrf v1
 address ovpnuni ovpnmlt
 local-as 1
 router-id 4.4.4.1
 neigh 2.2.2.206 remote-as 1
 neigh 2.2.2.206 update lo0
 neigh 2.2.2.206 send-comm both
 afi-ovrf v2 ena
...
router bgp6 1
 ...
 local-as 1
 router-id 6.6.6.1
 neigh 4321::206 remote-as 1
 neigh 4321::206 update lo0
 neigh 4321::206 send-comm both
 afi-ovrf v2 ena
 afi-ovrf v2 red conn
 afi-ovrf v2 red stat
 exit
...
addother r2 controller r1 v9 9080 - feature vlan route mroute duplab
...
r6 tping 100 10 2.2.2.103 vrf v2 sou lo1
r6 tping 100 10 4321::103 vrf v2 sou lo1
r6 tping 100 10 2.2.2.104 vrf v2 sou lo1
r6 tping 100 10 4321::104 vrf v2 sou lo1
r6 tping 100 10 2.2.2.105 vrf v2 sou lo1
r6 tping 100 10 4321::105 vrf v2 sou lo1
r6 tping 100 10 2.2.2.106 vrf v2 sou lo1
r6 tping 100 10 4321::106 vrf v2 sou lo1

r6 tping 300 5 232.2.2.2 vrf v2 sou lo1 multi
r6 tping 300 5 ff06::1 vrf v2 sou lo1  multi

r1 dping sdn . r6 232.2.2.2 vrf v2 sou lo1
r1 dping sdn . r6 ff06::1 vrf v2 sou lo1
