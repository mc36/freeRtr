...
r1 tping 0 40 2.2.2.2 vrf v1 int lo1
r1 tping 0 40 2.2.2.3 vrf v1 int lo1
r1 tping 0 40 4321::2 vrf v1 int lo1
r1 tping 0 40 4321::3 vrf v1 int lo1

r2 tping 0 40 2.2.2.1 vrf v1 int lo1
r2 tping 0 40 2.2.2.3 vrf v1 int lo1
r2 tping 0 40 4321::1 vrf v1 int lo1
r2 tping 0 40 4321::3 vrf v1 int lo1

r3 tping 0 40 2.2.2.1 vrf v1 int lo1
r3 tping 0 40 2.2.2.2 vrf v1 int lo1
r3 tping 0 40 4321::1 vrf v1 int lo1
r3 tping 0 40 4321::2 vrf v1 int lo1
