description bgp change in leak-role with soft-reconfig
...
route-map rm1
 ...
 sequence 10 match customer 4000-6000
...
route-map rm1
 sequence 10 act deny
 sequence 10 match customer 2000-4000
 sequence 20 act perm
 exit
router bgp4 1
 vrf v1
