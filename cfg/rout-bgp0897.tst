description vpns over ibgp rr without client reflection
...
r2 tping 0 60 9.9.2.3 vrf v2
r2 tping 0 60 9992::3 vrf v2

r3 tping 100 60 9.9.2.1 vrf v2
r3 tping 100 60 9992::1 vrf v2
r3 tping 0 60 9.9.2.2 vrf v2
r3 tping 0 60 9992::2 vrf v2
...
r2 tping 0 60 9.9.3.3 vrf v3
r2 tping 0 60 9993::3 vrf v3

r3 tping 100 60 9.9.3.1 vrf v3
r3 tping 100 60 9993::1 vrf v3
r3 tping 0 60 9.9.3.2 vrf v3
r3 tping 0 60 9993::2 vrf v3
