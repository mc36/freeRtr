description bgp change in aggregator with soft-reconfig
...
route-map rm1
 ...
 sequence 10 match aggregator 4000-6000
...
route-map rm1
 sequence 10 act deny
 sequence 10 match aggregator 2000-4000
 sequence 20 act perm
 exit
router bgp4 1
 vrf v1
...
r3 send set aggregator 3000 1.1.1.111
r3 send end
...
r3 send conf t
r3 send route-map rm1
r3 send set aggregator 5000 1.1.1.111
r3 send end
r3 send clear ipv4 route v1
r3 send clear ipv6 route v1
...
r3 send conf t
r3 send route-map rm1
r3 send set aggregator 1000 1.1.1.111
r3 send end
r3 send clear ipv4 route v1
r3 send clear ipv6 route v1
