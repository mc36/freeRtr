description bgp interas vpn with multiple labels
...
router bgp4 1
 ...
 neigh 2.2.2.2 multiple-label vpnuni
 afi-vrf v2 ena
 afi-vrf v2 red conn
 exit
router bgp6 1
 ...
 neigh 4321::2 multiple-label vpnuni
 afi-vrf v2 ena
 afi-vrf v2 red conn
 exit
!
...
router bgp4 1
 ...
 neigh 1.1.1.10 multiple-label vpnuni
...
router bgp6 1
 ...
 neigh 1234:3::2 multiple-label vpnuni
