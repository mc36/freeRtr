...
public class userConfig {
    ...
    private void getHelpIpX(userHelping l) {
        ...
        l.add("10 .                    randomize          randomize source port");
        l.add("8  9,.              <new>                  translated address");
        l.add("9  .                  randomize            randomize source port");
        ...
        l.add("11 .                      randomize        randomize source port");
        ...
        l.add("13 .                          randomize    randomize source port");
        l.add("10 11                   <new>              translated address");
        l.add("11 12,.                   <new>            translated port");
        l.add("12 .                        randomize      randomize source port");
        ...
        l.add("14 .                            randomize  randomize source port");
