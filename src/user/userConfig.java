...
public class userConfig {
    ...
    private userHelping getHelpGlobal() {
        ...
        l.add("3  .      <num>                      process id");
        l.add("2  3    bgp4                         border gateway protocol for ipv4");
        l.add("3  .      <num>                      process id");
        l.add("2  3    bgp6                         border gateway protocol for ipv6");
        l.add("3  .      <num>                      process id");
        l.add("2  3    msdp4                        multicast source discovery protocol for ipv4");
        l.add("3  .      <num>                      process id");
        l.add("2  3    msdp6                        multicast source discovery protocol for ipv6");
        l.add("3  .      <num>                      process id");
        l.add("2  3    flowspec4                    flowspec rewriter for ipv4");
        l.add("3  .      <num>                      process id");
        ...
        l.add("3  .      <num>                      process id");
        l.add("2  3    uni2flow4                    unicast to flowspec for ipv4");
        l.add("3  .      <num>                      process id");
