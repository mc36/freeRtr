...
class servHttpConn implements Runnable {
    ...
    private boolean sendOneDir(String s) {
        ...
        rsp += "</table><br/>listed " + dirs + " dirs and " + fils + " files, using " + lens + " bytes, modified between " + bits.time2str(cfgAll.timeZoneName, frst, 3) + " and " + bits.time2str(cfgAll.timeZoneName, last, 3) + ".<br/>";
