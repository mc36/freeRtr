...
class servHttpConn implements Runnable {
    ...
    private boolean sendOneDir(String s) {
        ...
        String rsp = servHttp.html401tr + "\n<html><head><title>dirlist</title></head><body" + getStyle() + ">\n";
        ...
        rsp += "</table><br/>listed " + dirs + " dirs and " + fils + " files, using " + lens + " bytes,<br/>";
        rsp += "modified between " + bits.time2str(cfgAll.timeZoneName, frst, 3) + " and " + bits.time2str(cfgAll.timeZoneName, last, 3) + ".<br/>";
        rsp += "<br/><i>generated by </i><b>" + version.namVer + "</b>.</body></html>\n";
