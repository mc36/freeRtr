...
public class rtrBgpSpeak implements rtrBfdClnt, Runnable {
    ...
    public int getPrefixGot() {
        return lrnUni.size() + lrnMlt.size() + lrnOtrU.size()
                ...
                + lrnMdt.size() + lrnSrte.size() + lrnLnks.size()
    ...
    public boolean parseUpdate(packHolder pck, packHolder hlp) {
        ...
        addAttribed(currOtrF, parent.afiOtrF, ntry, neigh.vroumapIn, neigh.vroupolIn, null);
        addAttribed(currSrte, parent.afiSrte, ntry, neigh.vroumapIn, neigh.vroupolIn, null);
        addAttribed(currOtrS, parent.afiOtrS, ntry, neigh.vroumapIn, neigh.vroupolIn, null);
        ...
        addAttribed(currVpoU, parent.afiVpoU, ntry, neigh.vroumapIn, neigh.vroupolIn, null);
        addAttribed(currVpoM, parent.afiVpoM, ntry, neigh.vroumapIn, neigh.vroupolIn, null);
        ...
        addAttribed(currMvpo, parent.afiMvpo, ntry, neigh.vroumapIn, neigh.vroupolIn, null);
