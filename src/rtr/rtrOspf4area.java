...
public class rtrOspf4area implements Comparator<rtrOspf4area>, Runnable {
    ...
    private void createExtLsas() {
        ...
        if (defOrigin) {
            ...
            tabRoute.addUpdatedEntry(tabRoute.addType.better, rs, rtrBgpUtil.safiUnicast, 0, ntry, true, roumapInto, roupolInto, prflstInto);
        }
        tabRoute.addUpdatedTable(tabRoute.addType.better, rtrBgpUtil.safiUnicast, 0, rs, lower.routerRedistedU, true, roumapInto, roupolInto, prflstInto);
        ...
        for (int i = 0; i < lsas.size(); i++) {
            ...
            switch (ntry.lsaType) {
                ...
                case rtrOspf4lsa.lsaSumNet:
                    ...
                    pref.best.metric = (o & 0xffffff) + met;
                ...
                case rtrOspf4lsa.lsaOpArea:
                    ...
                    for (;;) {
                        ...
                        spf.addSegRouI(ntry.rtrID, pref.best.segrouIdx);
                        spf.addBierI(ntry.rtrID, pref.best.bierIdx, old.best.origin == 109);
                        ...
                        lower.segrouLab[pref.best.segrouIdx].setFwdMpls(8, lower.fwdCore, (ipFwdIface) old.best.iface, old.best.nextHop, old.best.labelRem);
