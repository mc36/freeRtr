...
public class clntWireguard implements Runnable, prtServP, ifcDn {
    ...
    private void workDoer() {
        ...
        conn = udp.packetConnect(this, fwdIfc, srcPrt, trg, trgPrt, "wireguard", null, -1);
        if (conn == null) {
            return;
        }
        conn.timeout = 120000;
    ...
    public synchronized void sendPack(packHolder pck) {
        ...
        cryEnchChacha20 en = new cryEnchChacha20();
    ...
    private static byte[] encAead(byte[] key, byte[] msg, byte[] auth) {
        cryEnchChacha20 c = new cryEnchChacha20();
