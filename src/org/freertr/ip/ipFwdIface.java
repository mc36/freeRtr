...
public class ipFwdIface extends tabRouteIface {
    ...
    /**
     * minimal multicast ttl out
     */
    public int mcastTtlOut;
    ...
    public static void getHelp(userHelp l) {
        ...
        l.add(null, false, 3, new int[]{4}, "ttl-threshold-in", "ttl threshold for received multicast packets");
    ...
    public boolean doConfig(String a, cmds cmd, ipCor cor, ipFwd fwd, prtUdp udp, prtTcp tcp) {
        ...
        if (a.equals("multicast")) {
            ...
            if (a.equals("ttl-threshold-in")) {
                mcastTtlIn = bits.str2num(cmd.word());
                return false;
            }
            if (a.equals("ttl-threshold-out")) {
                mcastTtlOut = bits.str2num(cmd.word());
                return false;
            }
