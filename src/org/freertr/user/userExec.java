...
public class userExec {
    ...
    private static void getHelpShowIpX(userHelp hl) {
        ...
        hl.add(null, false, 7, new int[]{8, -1}, "other-learned", "other routes learned from neighbor");
        hl.add(null, false, 8, new int[]{-1}, "[addr]", "prefix to view");
        hl.add(null, false, 7, new int[]{8, -1}, "other-adverted", "other routes advertised to neighbor");
        hl.add(null, false, 8, new int[]{-1}, "[addr]", "prefix to view");
    ...
    public static void getHelpShow(userHelp hl, boolean privi) {
        ...
        hl.add(null, false, 2, new int[]{3}, "lwapp", "lwapp protocol information");
        hl.add(cfgAll.dmnLwapp.listServers(), false, 3, new int[]{-1}, "<name:loc>", "server name");
        ...
        hl.add(null, false, 4, new int[]{5, -1}, "done-mpls", "exported labels");
        hl.add(null, false, 5, new int[]{-1}, "[num]", "label to view");
        ...
        hl.add(null, false, 5, new int[]{6, -1}, "<num>", "vrf number");
        hl.add(null, false, 6, new int[]{-1}, "[addr]", "prefix to view");
    ...
    public userHelp getHelping() {
        ...
        hl.add(null, false, 3, new int[]{3, -1}, "[str]", "text");
        hl.add(null, false, 2, new int[]{3}, "spot-show", "view demo");
        hl.add(null, false, 3, new int[]{3, -1}, "[str]", "command");
        hl.add(null, false, 2, new int[]{3}, "rot-show", "view demo");
        hl.add(null, false, 3, new int[]{3, -1}, "[str]", "command");
        ...
        hl.add(null, false, 4, new int[]{-1}, "<addr>", "peer address");
        hl.add(null, false, 2, new int[]{3}, "lwapp", "lwapp protocol client");
        hl.add(cfgAll.dmnLwapp.listServers(), false, 3, new int[]{4}, "<name:loc>", "server name");
        hl.add(null, false, 4, new int[]{-1}, "<addr>", "peer address");
        ...
        hlp.add(null, false, 2, new int[]{3}, "recount", "recursive count directory usage");
        ...
        hlp.add(null, false, 3, new int[]{-1}, "<file>", "filename");
        hlp.add(null, false, 2, new int[]{3}, "tcttype", "type one binary file");
        hlp.add(null, false, 3, new int[]{-1}, "<file>", "filename");
        ...
        hl.add(null, false, 3, new int[]{4}, "<src>", "source file");
        hl.add(null, false, 4, new int[]{-1}, "<trg>", "target file");
        hl.add(null, false, 2, new int[]{3}, "recopy", "recursive copy directory");
        hl.add(null, false, 3, new int[]{4}, "<src>", "source file");
        hl.add(null, false, 4, new int[]{-1}, "<trg>", "target file");
        hl.add(null, false, 2, new int[]{3}, "recompare", "recursive compare directory");
        hl.add(null, false, 3, new int[]{4}, "<src>", "source file");
        hl.add(null, false, 4, new int[]{-1}, "<trg>", "target file");
        ...
        hl.add(null, false, 2, new int[]{3, -1}, "cleanup", "clear up flash");
        hl.add(null, false, 3, new int[]{4, -1}, "backup", "clear routing software backup");
        hl.add(null, false, 4, new int[]{-1}, "[str]", "path to clean");
        hl.add(null, false, 3, new int[]{4}, "older", "clear older files");
        hl.add(null, false, 4, new int[]{5}, "<num>", "seconds");
        hl.add(null, false, 5, new int[]{-1}, "<str>", "path to clean");
        hl.add(null, false, 3, new int[]{4}, "small", "clear small files");
        hl.add(null, false, 4, new int[]{5}, "<num>", "bytes");
        hl.add(null, false, 5, new int[]{-1}, "<str>", "path to clean");
        ...
        hl.add(null, false, 3, new int[]{-1}, "<file>", "filename");
        hl.add(null, false, 2, new int[]{3}, "tctview", "view one binary file");
        hl.add(null, false, 3, new int[]{-1}, "<file>", "filename");
