...
public class userExec {
    ...
    private static void getHelpPipes(userHelp hl, int beg, int rnd) {
        if (rnd >= 3) {
            return;
        }
        hl.add(null, false, beg, new int[]{beg + 1}, "|", "output modifier");
        hl.add(null, false, beg + 1, new int[]{beg + 3, -1}, "headers", "only section headers");
        getHelpPipes(hl, beg + 3, rnd + 1);
        hl.add(null, false, beg + 1, new int[]{beg + 3, -1}, "level", "raw level hierarchy");
        getHelpPipes(hl, beg + 3, rnd + 1);
        hl.add(null, false, beg + 1, new int[]{beg + 3, -1}, "csv", "level hierarchy in csv");
        getHelpPipes(hl, beg + 3, rnd + 1);
        hl.add(null, false, beg + 1, new int[]{beg + 3, -1}, "html", "level hierarchy in html");
        getHelpPipes(hl, beg + 3, rnd + 1);
        hl.add(null, false, beg + 1, new int[]{beg + 3, -1}, "xml", "level hierarchy in xml");
        getHelpPipes(hl, beg + 3, rnd + 1);
        hl.add(null, false, beg + 1, new int[]{beg + 3, -1}, "setdel", "level hierarchy in set/delete");
        getHelpPipes(hl, beg + 3, rnd + 1);
        ...
        getHelpPipes(hl, beg + 3, rnd + 1);
        hl.add(null, false, beg + 1, new int[]{beg + 3, -1}, "raw", "unfiltered");
        getHelpPipes(hl, beg + 3, rnd + 1);
    ...
    public static void getHelpShow(userHelp hl, boolean privi) {
        ...
        hl.add(null, false, 3, new int[]{-1}, "routing", "routing information");
