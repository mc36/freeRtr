...
public class userConfig {
    ...
    private void getHelpIpX(userHelping l) {
        ...
        l.add(null, "7  8          sequential-port-allocation   uses the first available source port in range (sequential)");
        l.add(null, "8  9                <num>                  lowest port number");
        l.add(null, "9  .                  <num>                highest port number");
        l.add(null, "7  8              random-port-allocation   randomizes source port numbers");
        l.add(null, "8  9                <num>                  lowest port number");
        l.add(null, "9  .                  <num>                highest port number");
        l.add(null, "7  8   preserve-original-then-sequential   preserve original port if possible, otherwise use sequential allocation");
        l.add(null, "8  9                <num>                  lowest port number");
        l.add(null, "9  .                  <num>                highest port number");
        l.add(null, "7  8       preserve-original-then-random   preserve original port if possible, otherwise use random allocation");
        l.add(null, "8  9                <num>                  lowest port number");
        l.add(null, "9  .                  <num>                highest port number");
