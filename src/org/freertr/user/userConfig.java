...
public class userConfig {
    ...
    private void getHelpIpX(userHelp l) {
        ...
        l.add(null, false, 5, new int[]{6}, "sample", "set sample value");
        l.add(null, false, 6, new int[]{5, -1}, "<num>", "one of every n packet");
        ...
        l.add(null, false, 8, new int[]{9}, "interface", "translated interface");
        l.add(null, false, 9, new int[]{10}, "<name:ifc>", "translated interface");
        l.add(null, false, 10, new int[]{-1}, "<mask>", "address mask");
        l.add(null, false, 7, new int[]{8}, "interface", "original interface");
        l.add(null, false, 8, new int[]{9}, "<name:ifc>", "original interface");
        l.add(null, false, 9, new int[]{10}, "<new>", "translated address");
        l.add(null, false, 10, new int[]{-1}, "<mask>", "address mask");
        l.add(null, false, 9, new int[]{10}, "interface", "translated interface");
        l.add(null, false, 10, new int[]{11}, "<name:ifc>", "translated interface");
        l.add(null, false, 11, new int[]{-1}, "<mask>", "address mask");
