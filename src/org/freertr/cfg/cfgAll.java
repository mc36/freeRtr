...
public class cfgAll {
    ...
    public final static String[] defaultL = {
        ...
        "!" + cmds.negated + cmds.tabulator + "logging milliseconds",
        "!" + cmds.negated + cmds.tabulator + "logging proxy",
        "!" + cmds.negated + cmds.tabulator + "logging rotate",
        "!" + cmds.negated + cmds.tabulator + "logging syslog debug kernel",
        "!" + cmds.negated + cmds.tabulator + "logging file debug",
        "!" + cmds.negated + cmds.tabulator + "logging irc debug",
        "!" + cmds.negated + cmds.tabulator + "logging tracestop",
        "!banner encoded ",
        "!" + cmds.negated + cmds.tabulator + "password-encrypt",
        "!" + cmds.negated + cmds.tabulator + "enable",
        "!" + cmds.negated + cmds.tabulator + "locale",
        // client
        "!" + cmds.negated + cmds.tabulator + "client pastebin",
        "!" + cmds.negated + cmds.tabulator + "client capture-path",
        ...
        "!" + cmds.negated + cmds.tabulator + "client bullying",
        "!" + cmds.negated + cmds.tabulator + "client proxy",
        "!" + cmds.negated + cmds.tabulator + "client domain-name",
        "!" + cmds.negated + cmds.tabulator + "client domain-lookup",
        "!" + cmds.negated + cmds.tabulator + "client name-proxy",
        "!client name-server",
        "!client time-zone Z",
        ...
        "!" + cmds.negated + cmds.tabulator + "client upgrade-script",
        ...
        "!" + cmds.negated + cmds.tabulator + "client config-save",
        "!" + cmds.negated + cmds.tabulator + "client config-archive",
        "!" + cmds.negated + cmds.tabulator + "client config-backup",
        "!" + cmds.negated + cmds.tabulator + "client config-exclusive",
        "!" + cmds.negated + cmds.tabulator + "client mail-proxy",
        "!" + cmds.negated + cmds.tabulator + "client mail-server",
        ...
        "!client ftp-passive",
        "!" + cmds.negated + cmds.tabulator + "client ftp-proxy",
        "!" + cmds.negated + cmds.tabulator + "client pop3-proxy",
        "!client ipv4-tos 0",
        "!client ipv4-ttl 255",
        "!client ipv6-tos 0",
        "!client ipv6-ttl 255",
        ...
        "!" + cmds.negated + cmds.tabulator + "client tcp-timestamp",
        "!" + cmds.negated + cmds.tabulator + "client tcp-ecn",
        "!" + cmds.negated + cmds.tabulator + "client tcp-keepalive",
