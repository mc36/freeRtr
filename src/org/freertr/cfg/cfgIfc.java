...
public class cfgIfc implements Comparable<cfgIfc>, cfgGeneric {
    ...
    public final static String[] defaultL = {
        ...
        "interface .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "router ospf[46] .* ldp-sync",
        ...
        "interface .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "router rift[46] .* ldp-sync",
        ...
        "interface .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "router pvrp[46] .* ldp-sync",
        ...
        "interface .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "router lsrp[46] .* ldp-sync",
        ...
        "interface .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "router isis[46] .* ldp-sync",
