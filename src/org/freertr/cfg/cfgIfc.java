...
import org.freertr.ifc.ifcAtaOE;
...
import org.freertr.ifc.ifcSmds;
...
import org.freertr.prt.prt4to6;
...
public class cfgIfc implements Comparable<cfgIfc>, cfgGeneric {
    ...
    /**
     * ataoe server handler
     */
    public ifcAtaOE ataoeS;
    ...
    public final static userFilter[] defaultF = {
        ...
        new userFilter("interface .*", cmds.tabulator + "ipv[46] multicast ttl-threshold-in 0", null),
        new userFilter("interface .*", cmds.tabulator + "ipv[46] multicast ttl-threshold-out 0", null),
        ...
        new userFilter("interface .*", cmds.tabulator + "router isis[46] .* csnp-time 0", null),
        ...
        // smds
        new userFilter("interface .*", cmds.tabulator + cmds.negated + cmds.tabulator + "smds nec-mode", null),
        new userFilter("interface .*", cmds.tabulator + cmds.negated + cmds.tabulator + "smds dxi-mode", null),
        // tunnel
    ...
    private synchronized boolean initEncap(String a) {
        ...
        switch (enc) {
            ...
            case 11:
                ...
                break;
            case 12:
                dvbgse = new ifcDvbGse();
                lower.setUpper(dvbgse);
                dvbgse.setUpper(ethtyp);
                break;
            case 13:
                smds = new ifcSmds();
                lower.setUpper(smds);
    ...
    public synchronized boolean setup2tunnel() {
        ...
        switch (tunMode) {
            ...
            case Sto6:
                ...
                tun4to6 = new prt4to6(tunTrg, new cmds("dom", tunFQDN));
                tun4to6.setUpper(ethtyp);
                lower = tun4to6;
                break;
            case aplusp:
                if (tunFQDN == null) {
    ...
    public List<String> getShRun(int filter) {
        ...
        if (dvbgse != null) {
            dvbgse.getConfig(l, cmds.tabulator + "dvbgse ");
        }
        if (smds != null) {
    ...
    public void getHelp(userHelp l) {
        ...
        ifcLapb.getHelp(l);
        l.add(null, false, 1, new int[]{2}, "dvbgse", "dvb gse parameters on the interface");
        ifcDvbGse.getHelp(l);
        ...
        l.add(null, false, 3, new int[]{-1}, "4to6", "ipv4 to ipv6 protocol translator");
