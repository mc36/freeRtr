...
public class cfgVrf implements Comparable<cfgVrf>, cfgGeneric {
    ...
    public final static String[] defaultL = {
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "description",
        "vrf definition .*!" + cmds.tabulator + "rd 0:0",
        "vrf definition .*!" + cmds.tabulator + "update4interval 0",
        "vrf definition .*!" + cmds.tabulator + "update6interval 0",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "optimize4lookup",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "optimize6lookup",
        "vrf definition .*!" + cmds.tabulator + "rt4import",
        "vrf definition .*!" + cmds.tabulator + "rt4export",
        "vrf definition .*!" + cmds.tabulator + "rt6import",
        "vrf definition .*!" + cmds.tabulator + "rt6export",
        "vrf definition .*!" + cmds.tabulator + "clr4import",
        "vrf definition .*!" + cmds.tabulator + "clr4export",
        "vrf definition .*!" + cmds.tabulator + "clr6import",
        ...
        "vrf definition .*!" + cmds.tabulator + "label6common 0",
        "vrf definition .*!" + cmds.tabulator + "iface4start 0",
        "vrf definition .*!" + cmds.tabulator + "iface6start 0",
        "vrf definition .*!" + cmds.tabulator + "route4limit 0 0 0 0",
        "vrf definition .*!" + cmds.tabulator + "route6limit 0 0 0 0",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "import4list",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "import6list",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "export4list",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "export6list",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "import4map",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "import6map",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "export4map",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "export6map",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "import4policy",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "import6policy",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "export4policy",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "export6policy",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "dapp4",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "dapp6",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "copp4in",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "copp4out",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "copp6in",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "copp6out",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "packet4filter",
        "vrf definition .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "packet6filter",
        "vrf definition .*!" + cmds.tabulator + "incremental4 1000",
        "vrf definition .*!" + cmds.tabulator + "incremental6 1000",
    ...
    public void getHelp(userHelping l) {
        ...
        l.add(null, "1 2  unreach4rate        rate limit icmp generation");
        l.add(null, "2 3    <num>             packets allowed");
        l.add(null, "3 .      <num>           millisecs between them");
        l.add(null, "1 2  unreach6rate        rate limit icmp generation");
        l.add(null, "2 3    <num>             packets allowed");
        l.add(null, "3 .      <num>           millisecs between them");
