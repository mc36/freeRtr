...
public class cfgRtr implements Comparable<cfgRtr>, cfgGeneric {
    ...
    public final static userFilter[] defaultF = {
        ...
        new userFilter("router pvrp[46] .*", cmds.tabulator + cmds.negated + cmds.tabulator + "afi-other foreign", null),
        ...
        new userFilter("router bgp[46] .*", cmds.tabulator + cmds.negated + cmds.tabulator + "mpns-readvert", null),
        ...
        new userFilter("router bgp[46] .*", cmds.tabulator + cmds.negated + cmds.tabulator + "(template|neighbor) .* memory", null),
        ...
        new userFilter("router bgp[46] .*", cmds.tabulator + cmds.negated + cmds.tabulator + "(template|neighbor) .* log-downlink-changes", null),
        ...
        new userFilter("router bgp[46] .*", cmds.tabulator + cmds.negated + cmds.tabulator + "afi-vrf .* mpns-advert", null),
        new userFilter("router bgp[46] .*", cmds.tabulator + cmds.negated + cmds.tabulator + "afi-vrf .* mpns-readvert", null),
        new userFilter("router bgp[46] .*", cmds.tabulator + cmds.negated + cmds.tabulator + "afi-vrf .* mpns-install", null),
        ...
        new userFilter("router bgp[46] .*", cmds.tabulator + cmds.negated + cmds.tabulator + "afi-ovrf .* mpns-advert", null),
        new userFilter("router bgp[46] .*", cmds.tabulator + cmds.negated + cmds.tabulator + "afi-ovrf .* mpns-readvert", null),
        new userFilter("router bgp[46] .*", cmds.tabulator + cmds.negated + cmds.tabulator + "afi-ovrf .* mpns-install", null),
