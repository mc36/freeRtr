...
public class cfgRtr implements Comparable<cfgRtr>, cfgGeneric {
    ...
    public final static userFilter[] defaultF = {
        ...
        new userFilter("router bgp[46] .*", cmds.tabulator + "(template|neighbor) .* additional-path-rx", null),
        new userFilter("router bgp[46] .*", cmds.tabulator + "(template|neighbor) .* additional-path-tx", null),
        ...
        new userFilter("router bgp[46] .*", cmds.tabulator + "(template|neighbor) .* graceful-restart", null),
        new userFilter("router bgp[46] .*", cmds.tabulator + "(template|neighbor) .* longlived-graceful", null),
        new userFilter("router bgp[46] .*", cmds.tabulator + "(template|neighbor) .* multiple-labels", null),
        new userFilter("router bgp[46] .*", cmds.tabulator + "(template|neighbor) .* extended-nexthop-current", null),
        new userFilter("router bgp[46] .*", cmds.tabulator + "(template|neighbor) .* extended-nexthop-other", null),
