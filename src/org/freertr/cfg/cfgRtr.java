...
public class cfgRtr implements Comparator<cfgRtr>, cfgGeneric {
    ...
    public final static String[] defaultL = {
        ...
        "router rift[46] .*! no default-originate",
        "router rift[46] .*! spf-log 0",
        "router rift[46] .*! no spf-topolog",
        "router rift[46] .*! no spf-bidir",
        "router rift[46] .*! no spf-hops",
        "router rift[46] .*! no spf-ecmp",
        "router rift[46] .*! no prefix-list",
        "router rift[46] .*! no route-map",
        "router rift[46] .*! no route-policy",
        // router pvrp
        ...
        "router bgp[46] .*! longlived-graceful 0",
        ...
        "router bgp[46] .*! (template|neighbor) .* randomize-startup 2 15",
        ...
        "router bgp[46] .*! (template|neighbor) .* longlived-graceful",
        ...
        "router bgp[46] .*! no (template|neighbor) .* log-end-changes",
        "router bgp[46] .*! no (template|neighbor) .* log-nexthop-changes",
        "router bgp[46] .*! no (template|neighbor) .* log-length-changes",
        ...
        "router bgp[46] .*! no (template|neighbor) .* evpn-route-map-in",
        "router bgp[46] .*! no (template|neighbor) .* evpn-route-map-out",
        "router bgp[46] .*! no (template|neighbor) .* evpn-route-policy-in",
        "router bgp[46] .*! no (template|neighbor) .* evpn-route-policy-out",
        ...
        "router bgp[46] .*! afi-ovrf .* import l3vpn",
        "router bgp[46] .*! afi-ovrf .* export l3vpn",
        "router bgp[46] .*! no afi-ovrf .* flowspec-advert",
        "router bgp[46] .*! no afi-ovrf .* flowspec-install",
        "router bgp[46] .*! no afi-ovrf .* mvpn",
        "router bgp[46] .*! afi-clr .* distance -1",
        "router bgp[46] .*! no afi-clr .* default-originate",
        "router bgp[46] .*! no afi-clr .* flowspec-advert",
        "router bgp[46] .*! no afi-clr .* flowspec-install",
        "router bgp[46] .*! no afi-clr .* mvpn",
        "router bgp[46] .*! afi-oclr .* distance -1",
        "router bgp[46] .*! no afi-oclr .* default-originate",
        "router bgp[46] .*! no afi-oclr .* flowspec-advert",
        "router bgp[46] .*! no afi-oclr .* flowspec-install",
        "router bgp[46] .*! no afi-oclr .* mvpn",
