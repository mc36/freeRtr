...
public class cfgRtr implements Comparable<cfgRtr>, cfgGeneric {
    ...
    public final static String[] defaultL = {
        ...
        "router ospf[46] .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "area .* ha-mode",
        ...
        "router ospf[46] .*!" + cmds.tabulator + "area .* hostname",
        ...
        "router isis[46] .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "afi-other multi-topology",
        "router isis[46] .*!" + cmds.tabulator + "afi-other distance 115 115",
        "router isis[46] .*!" + cmds.tabulator + "afi-other metric-wide",
        ...
        "router isis[46] .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "level[12] ha-mode",
        ...
        "router bgp[46] .*!" + cmds.tabulator + "(template|neighbor) .* route-refresh-original",
        "router bgp[46] .*!" + cmds.tabulator + "(template|neighbor) .* route-refresh-enhanced",
        ...
        "router bgp[46] .*!" + cmds.tabulator + cmds.negated + cmds.tabulator + "afi-spf stub",
