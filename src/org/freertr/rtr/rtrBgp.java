    ...
    public rtrBgp(ipFwd forwarder, cfgVrf vrfcfg, prtTcp protoT, int id) {
        ...
        switch (fwdCore.ipVersion) {
            case ipCor4.protocolVersion:
                ...
                ////safi2rdr[rtrBgpParam.idxLab] = addrSafi.safiIp4lab;
                ////safi2rdr[rtrBgpParam.idxCtp] = addrSafi.safiIp4ctp;
                ////safi2rdr[rtrBgpParam.idxCar] = addrSafi.safiIp4car;
                safi2rdr[rtrBgpParam.idxMlt] = addrSafi.ipv4uni;
                ////safi2rdr[rtrBgpParam.idxOlab] = addrSafi.safiIp6lab;
                ////safi2rdr[rtrBgpParam.idxOctp] = addrSafi.safiIp6ctp;
                ...
                ////safi2rdr[rtrBgpParam.idxFlw] = addrSafi.safiIp4flow;
                safi2rdr[rtrBgpParam.idxVpnU] = addrSafi.vpnv4uni;
                ////safi2rdr[rtrBgpParam.idxVpnM] = addrSafi.safiIp4vpnM;
                ////safi2rdr[rtrBgpParam.idxVpnF] = addrSafi.safiIp4vpnF;
                safi2rdr[rtrBgpParam.idxVpoU] = addrSafi.vpnv6uni;
                ////safi2rdr[rtrBgpParam.idxVpoM] = addrSafi.safiIp6vpnM;
                ...
                ////safi2rdr[rtrBgpParam.idxSpf] = addrSafi.safiIp46spf;
                ////safi2rdr[rtrBgpParam.idxRtf] = addrSafi.safiRtf46;
                ////safi2rdr[rtrBgpParam.idxLnks] = addrSafi.safiIp46lnks;
            ...
            case ipCor6.protocolVersion:
                ...
                ////safi2rdr[rtrBgpParam.idxLab] = addrSafi.safiIp6lab;
                ////safi2rdr[rtrBgpParam.idxCtp] = addrSafi.safiIp6ctp;
                ////safi2rdr[rtrBgpParam.idxCar] = addrSafi.safiIp6car;
                safi2rdr[rtrBgpParam.idxMlt] = addrSafi.ipv6uni;
                ////safi2rdr[rtrBgpParam.idxOlab] = addrSafi.safiIp4lab;
                ////safi2rdr[rtrBgpParam.idxOctp] = addrSafi.safiIp4ctp;
                ...
                ////safi2rdr[rtrBgpParam.idxFlw] = addrSafi.safiIp6flow;
                safi2rdr[rtrBgpParam.idxVpnU] = addrSafi.vpnv6uni;
                ////safi2rdr[rtrBgpParam.idxVpnM] = addrSafi.safiIp6vpnM;
                ////safi2rdr[rtrBgpParam.idxVpnF] = addrSafi.safiIp6vpnF;
                safi2rdr[rtrBgpParam.idxVpoU] = addrSafi.vpnv4uni;
                ////safi2rdr[rtrBgpParam.idxVpoM] = addrSafi.safiIp4vpnM;
