    ...
    public rtrBgp(ipFwd forwarder, cfgVrf vrfcfg, prtTcp protoT, int id) {
        ...
        switch (fwdCore.ipVersion) {
            case ipCor4.protocolVersion:
                ...
                safi2rdr[rtrBgpParam.idxVpoM] = addrSafi.vpnv6mul;
                ////safi2rdr[rtrBgpParam.idxVpoF] = addrSafi.safiIp6vpnF;
                safi2rdr[rtrBgpParam.idxVpls] = addrSafi.vpls;
                safi2rdr[rtrBgpParam.idxMspw] = addrSafi.mspw;
                safi2rdr[rtrBgpParam.idxEvpn] = addrSafi.evpn;
                safi2rdr[rtrBgpParam.idxMdt] = addrSafi.mdt;
                safi2rdr[rtrBgpParam.idxNsh] = addrSafi.nsh;
                safi2rdr[rtrBgpParam.idxRpd] = addrSafi.rpd;
            ...
            case ipCor6.protocolVersion:
                ...
                safi2rdr[rtrBgpParam.idxVpoM] = addrSafi.vpnv4mul;
