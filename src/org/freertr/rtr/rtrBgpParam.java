...
public abstract class rtrBgpParam {
    ...
    public static void getParamHelp(userHelping l) {
        ...
        l.add(null, "3  4       rpki-in                     rpki ingress extcomm mode");
        ...
        l.add(null, "3  4       rpki-out                    rpki egress extcomm mode");
        l.add(null, "4  .         transparent               pass everything unmodified");
        l.add(null, "4  .         accept                    accept remote markings");
        l.add(null, "4  .         fix-unset                 remove remote markings");
        l.add(null, "4  .         rewrite                   always rewrite markings");
        ...
        l.add(null, "3  .       route-refresh-original      send original route refresh capability");
        l.add(null, "3  .       route-refresh-enhanced      send enhanced route refresh capability");
        ...
        l.add(null, "3  .       next-hop-multilabel         send multiple labels to peer");
