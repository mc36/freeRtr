 ...
 * @author matecsaba
 */
public class rtrOspf4 extends ipRtr implements prtRedunClnt {
    ...
    public synchronized void routerCreateComputed() {
        ...
        if (segrouLab != null) {
            ...
            for (int i = 0; i < segrouLab.length; i++) {
                ...
                segrouLab[i].setFwdDrop(tabLabelEntry.owner.ospf4srgb);
            }
        }
        if (bierLab != null) {
            int o = 0;
            ...
            for (int i = 0; i < bierLab.length; i++) {
                bierLab[i].setBierMpls(tabLabelEntry.owner.ospf4bier, fwdCore, res);
            }
        }
    ...
    public userFormat showStats(ipFwdIface iface) {
        ...
        for (int i = 0; i < ifc.msgStats.length; i++) {
            l.add(i + "|" + rtrOspf4neigh.msgTyp2string(i) + "|" + rtrBgpDump.counter2stats(ifc.msgStats[i]));
        }
        return l;
    }
