...
public class rtrGhosthunt extends ipRtr implements Runnable {
    ...
    public void routerGetHelp(userHelp l) {
        ...
        l.add(null, false, 1, new int[]{2}, "grace", "specify grace interval in ms");
        l.add(null, false, 2, new int[]{3}, "<num>", "for advertisement");
        l.add(null, false, 3, new int[]{-1}, "<num>", "for withdrawal");
        l.add(null, false, 1, new int[]{2}, "mode", "set mode");
        l.add(null, false, 2, new int[]{-1}, "originator", "select originator");
        l.add(null, false, 2, new int[]{-1}, "observer", "select observer");
        l.add(null, false, 1, new int[]{2}, "lookup", "set lookup");
        l.add(null, false, 2, new int[]{-1}, "vrf", "select vrf routes");
        l.add(null, false, 2, new int[]{-1}, "redist", "select redistribted");
        l.add(null, false, 2, new int[]{3}, "router", "select an other router");
        ...
        l.add(null, false, 1, new int[]{2}, "prefix", "specify prefix to use");
        l.add(null, false, 2, new int[]{-1}, "<str>", "prefix");
        l.add(null, false, 1, new int[]{2}, "nexthop", "specify nexthop to use");
        l.add(null, false, 2, new int[]{-1}, "<str>", "prefix");
        l.add(null, false, 1, new int[]{2}, "range", "specify time map to use");
        l.add(null, false, 2, new int[]{-1}, "<nam:tm>", "time map");
        l.add(null, false, 1, new int[]{2}, "send-map", "specify route map for advertisement");
        l.add(null, false, 2, new int[]{-1}, "<nam:rm>", "route map");
        l.add(null, false, 1, new int[]{2}, "send-policy", "specify route policy for advertisement");
        l.add(null, false, 2, new int[]{-1}, "<nam:rpl>", "route policy");
        l.add(null, false, 1, new int[]{2}, "recv-map", "specify route map for comparison");
        l.add(null, false, 2, new int[]{-1}, "<nam:rm>", "route map");
        l.add(null, false, 1, new int[]{2}, "recv-policy", "specify route policy for comparison");
        l.add(null, false, 2, new int[]{-1}, "<nam:rpl>", "route policy");
        l.add(null, false, 1, new int[]{2}, "ignore", "specify attributes to ignore");
