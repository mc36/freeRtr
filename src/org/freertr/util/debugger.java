...
public class debugger {
    ...
    public static void getHelping(userHelping l, int b) {
        l.add(null, (b + 0) + " " + (b + 1) + "      line                line specific protocols");
        l.add(null, (b + 1) + " .        config            configuration commands");
        l.add(null, (b + 1) + " .        exec              exec commands");
        l.add(null, (b + 1) + " .        reader            command line reader events");
        l.add(null, (b + 1) + " .        screen            terminal screen events");
        l.add(null, (b + 1) + " .        netconf           netconf events");
        l.add(null, (b + 1) + " .        xml               xml events");
        l.add(null, (b + 1) + " .        script            chat script handler");
        l.add(null, (b + 1) + " .        hwcfg             hardware config");
        l.add(null, (b + 1) + " .        swcfg             software config");
        l.add(null, (b + 1) + " .        ipinfo            ipinfo events");
        l.add(null, (b + 1) + " .        redundancy        redundancy events");
        l.add(null, (b + 1) + " .        watchdog          watchdog events");
        l.add(null, (b + 1) + " .        runner            line runner");
        l.add(null, (b + 1) + " .        thread            line thread");
        l.add(null, (b + 0) + " " + (b + 1) + "      server              protocol servers");
        l.add(null, (b + 1) + " .        dhcp4             ipv4 dynamic host config protocol");
        l.add(null, (b + 1) + " .        dhcp6             ipv6 dynamic host config protocol");
        l.add(null, (b + 1) + " .        dns               domain name server");
        l.add(null, (b + 1) + " .        ftp               file transfer protocol");
        l.add(null, (b + 1) + " .        tftp              trivival file transfer protocol");
        l.add(null, (b + 1) + " .        gopher            gopher protocol");
        l.add(null, (b + 1) + " .        plan9             plan9 protocol");
        l.add(null, (b + 1) + " .        ntp               network time protocol");
        l.add(null, (b + 1) + " .        irc               internet relay protocol");
        l.add(null, (b + 1) + " .        rpki              resource public key infrastructure");
        l.add(null, (b + 1) + " .        nrpe              nagios remote plugin");
        l.add(null, (b + 1) + " .        prometheus        prometheus targets");
        l.add(null, (b + 1) + " .        dcp               direct connect protocol");
        l.add(null, (b + 1) + " .        sdwan             sdwan protocol");
        l.add(null, (b + 1) + " .        pcep              path computation element protocol");
        l.add(null, (b + 1) + " " + (b + 2) + "        openflow          openflow protocol");
        l.add(null, (b + 2) + " .          rx              received packets");
        l.add(null, (b + 2) + " .          tx              transmitted packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        p4lang            p4lang protocol");
        l.add(null, (b + 2) + " .          rx              received messages");
        l.add(null, (b + 2) + " .          tx              transmitted messages");
        l.add(null, (b + 2) + " .          error           errored messages");
        l.add(null, (b + 2) + " .          traffic         messaged packets");
        l.add(null, (b + 1) + " .        snmp              simple network management protocol");
        l.add(null, (b + 1) + " .        iscsi             iscsi protocol");
        l.add(null, (b + 1) + " .        rfb               remote frame buffer protocol");
        l.add(null, (b + 1) + " .        scsi              scsi protocol");
        l.add(null, (b + 1) + " .        http              hypertext transfer protocol");
        l.add(null, (b + 1) + " .        lpd               line printer daemon protocol");
        l.add(null, (b + 1) + " .        pop3              post office protocol");
        l.add(null, (b + 1) + " .        imap4             internet mail access protocol");
        l.add(null, (b + 1) + " .        smtp              simple mail transfer protocol");
        l.add(null, (b + 1) + " .        modem             modulator demodulator");
        l.add(null, (b + 1) + " .        voice             voice script");
        l.add(null, (b + 1) + " .        sip               session initiation protocol");
        l.add(null, (b + 1) + " .        l2f               layer 2 forwarding protocol");
        l.add(null, (b + 1) + " .        l2tp2             layer 2 tunneling protocol v2");
        l.add(null, (b + 1) + " .        l2tp3             layer 2 tunneling protocol v3");
        l.add(null, (b + 1) + " .        pptp              point to point tunneling protocol");
        l.add(null, (b + 1) + " .        gtp               gprs tunneling protocol");
        l.add(null, (b + 1) + " .        radius            radius protocol");
        l.add(null, (b + 1) + " .        tacacs            tacacs protocol");
        l.add(null, (b + 0) + " " + (b + 1) + "      proto               transport protocols");
        l.add(null, (b + 1) + " " + (b + 2) + "        babel             babel routing protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        olsr              optimized link state routing protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        rip4              routing information protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        rip6              routing information protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        ospf4             open shortest path first protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        ospf6             open shortest path first protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        isis              intermediate system intermediate system protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        bgp               border gateway protocol");
        l.add(null, (b + 2) + " .          computation     computation events");
        l.add(null, (b + 2) + " .          incremental     incremental events");
        l.add(null, (b + 2) + " .          dampening       dampening events");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          full            full events");
        l.add(null, (b + 2) + " .          error           error events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        msdp              multicast source discovery protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        rpki              resource pulbic key infra protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        rsvp              resource reservation protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        ldp               label distribution protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        rift              routing in fat trees");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        pvrp              path vector routing protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        lsrp              link state routing protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        eigrp             enhanced interior gateway routing protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        pim               protocol independent multicast protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        bfd               bidirectional forwarding detection protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        ptp               precision time protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        hsrp              hot standby router protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " " + (b + 2) + "        vrrp              virtual router redundancy protocol");
        l.add(null, (b + 2) + " .          event           table events");
        l.add(null, (b + 2) + " .          traffic         interface packets");
        l.add(null, (b + 1) + " .        mhost             multicast host protocol");
        l.add(null, (b + 1) + " .        ssh               secure shell protocol");
        l.add(null, (b + 1) + " .        tls               transport layer security protocol");
        l.add(null, (b + 1) + " .        telnet            telnet protocol");
        l.add(null, (b + 1) + " .        websock           websocket protocol");
        l.add(null, (b + 1) + " .        http2             http2 protocol");
        l.add(null, (b + 1) + " .        ike               internet key exchange protocol");
        l.add(null, (b + 1) + " .        macsec            mac securicy protocol");
        l.add(null, (b + 1) + " .        dlep              dynamic link exchange protocol");
        l.add(null, (b + 1) + " .        gen               generic connections");
        l.add(null, (b + 1) + " .        tcp               transmission control protocol");
        l.add(null, (b + 1) + " .        udp               user datagram protocol");
        l.add(null, (b + 1) + " .        ludp              lightweight user datagram protocol");
        l.add(null, (b + 1) + " .        dccp              datagram congestion control protocol");
        l.add(null, (b + 1) + " .        sctp              stream control transmission protocol");
        l.add(null, (b + 1) + " .        gre               generic routing encapsulation");
        l.add(null, (b + 1) + " .        ipip              ip in ip encapsulation");
        l.add(null, (b + 0) + " " + (b + 1) + "      table               table events");
        l.add(null, (b + 1) + " .        conn              connection table");
        ...
        l.add(null, (b + 1) + " .        sip               session initiation protocol");
        l.add(null, (b + 1) + " .        pcep              path computation element protocol");
        l.add(null, (b + 1) + " .        sstp              secure socket tunneling protocol");
        l.add(null, (b + 1) + " .        sdwan             sdwan protocol");
        l.add(null, (b + 1) + " .        anyconn           anyconnect protocol");
        l.add(null, (b + 1) + " .        forti             fortinet protocol");
        l.add(null, (b + 1) + " .        pulse             pulsevpn protocol");
        l.add(null, (b + 1) + " .        snmp              simple network management protocol");
        l.add(null, (b + 1) + " .        dhcp4             ipv4 dynamic host config protocol");
        l.add(null, (b + 1) + " .        dhcp6             ipv6 dynamic host config protocol");
        l.add(null, (b + 1) + " .        slaac             stateless address autoconfiguration protocol");
        l.add(null, (b + 1) + " .        dns               domain name server");
        l.add(null, (b + 1) + " .        pop3              post office protocol");
        l.add(null, (b + 1) + " .        ftp               file transfer protocol");
        l.add(null, (b + 1) + " .        http              hypertext transfer protocol");
        l.add(null, (b + 1) + " .        smtp              simple mail transfer protocol");
        l.add(null, (b + 1) + " .        nrpe              nagios remote plugin");
        l.add(null, (b + 1) + " .        proxy             proxy protosols");
        l.add(null, (b + 1) + " .        tftp              trivival file transfer protocol");
        l.add(null, (b + 1) + " .        l2f               layer 2 forwarding protocol");
        l.add(null, (b + 1) + " .        l2tp2             layer 2 tunneling protocol v2");
        l.add(null, (b + 1) + " .        l2tp3             layer 2 tunneling protocol v3");
        l.add(null, (b + 1) + " .        pptp              point to point tunneling protocol");
        l.add(null, (b + 1) + " .        wireguard         wireguard protocol");
        l.add(null, (b + 1) + " .        gtp               gprs tunneling protocol");
        l.add(null, (b + 1) + " .        pwe               pseudowire over mpls protocol");
        l.add(null, (b + 1) + " .        mplste            mpls traffeng tunnel");
        l.add(null, (b + 1) + " .        mplsbier          mpls bier tunnel");
        l.add(null, (b + 1) + " .        mplssr            mpls segrout tunnel");
        l.add(null, (b + 1) + " .        polka             polka tunnel");
        l.add(null, (b + 1) + " .        mpolka            mpolka tunnel");
        l.add(null, (b + 1) + " .        automesh          mpls automesh tunnel");
        l.add(null, (b + 1) + " .        mplsldp           mpls ldp tunnel");
        l.add(null, (b + 1) + " .        radius            radius protocol");
        l.add(null, (b + 1) + " .        tacacs            tacacs protocol");
        l.add(null, (b + 0) + " " + (b + 1) + "      fwd                 protocol forwarding");
        l.add(null, (b + 1) + " .        event             forwarding events");
        l.add(null, (b + 1) + " .        packet            forwarded packets");
        l.add(null, (b + 1) + " .        fragmentation     packet fragmentation");
        l.add(null, (b + 1) + " .        reassembly        packet reassembly");
        l.add(null, (b + 1) + " .        srh               source routed packets");
        l.add(null, (b + 1) + " .        nsh               service chaining packets");
        l.add(null, (b + 0) + " " + (b + 1) + "      mpls                multiprotocol label switching");
        l.add(null, (b + 1) + " .        packet            mpls packet processing");
        l.add(null, (b + 1) + " .        bier              bier packet processing");
        l.add(null, (b + 0) + " " + (b + 1) + "      ipv4                internet protocol v4");
        l.add(null, (b + 1) + " .        packet            ip packet processing");
        l.add(null, (b + 1) + " .        icmp              internet control messaging protocol");
        l.add(null, (b + 1) + " " + (b + 2) + "        arp               address resolution protocol");
        l.add(null, (b + 2) + " .          packet          arp packets");
        l.add(null, (b + 2) + " .          event           arp events");
        l.add(null, (b + 0) + " " + (b + 1) + "      ipv6                internet protocol v6");
        l.add(null, (b + 1) + " .        packet            ip packet processing");
        l.add(null, (b + 1) + " .        icmp              internet control messaging protocol");
        l.add(null, (b + 1) + " " + (b + 2) + "        ndp               neighbor discovery protocol");
        l.add(null, (b + 2) + " .          packet          ndp packets");
        l.add(null, (b + 2) + " .          event           ndp events");
        l.add(null, (b + 0) + " " + (b + 1) + "      iface               interface protocols");
        l.add(null, (b + 1) + " .        drop              dropped packets");
        l.add(null, (b + 1) + " .        bridge            briding");
        l.add(null, (b + 1) + " .        bundle            bundlng");
        l.add(null, (b + 1) + " .        sgt               sgt encapsulation");
        l.add(null, (b + 1) + " .        dot1q             802.1q vlan");
        l.add(null, (b + 1) + " .        dot1ad            802.1ad vlan");
        l.add(null, (b + 1) + " .        dot1ah            802.1ah vlan");
        l.add(null, (b + 1) + " .        trill-mt          trill-mt vlan");
        l.add(null, (b + 1) + " .        trill-fgl         trill-fgl vlan");
        l.add(null, (b + 1) + " .        qinq1             qinq1 vlan");
        l.add(null, (b + 1) + " .        qinq2             qinq2 vlan");
        l.add(null, (b + 1) + " .        qinq3             qinq3 vlan");
        l.add(null, (b + 1) + " .        qinqx             qinqx vlan");
        l.add(null, (b + 1) + " .        isl               isl vlan");
        l.add(null, (b + 1) + " .        ethtyp            ethertypes");
        l.add(null, (b + 1) + " .        isdn              isdn encapsulation");
        l.add(null, (b + 1) + " .        hdlc              hdlc encapsulation");
        l.add(null, (b + 1) + " .        nhrp              nhrp encapsulation");
        l.add(null, (b + 1) + " .        framerelay        frame relay encapsulation");
        l.add(null, (b + 1) + " .        atmdxi            atm dxi encapsulation");
        l.add(null, (b + 1) + " .        atmsar            atm sar encapsulation");
        l.add(null, (b + 1) + " .        lapb              lapb encapsulation");
        l.add(null, (b + 1) + " .        ppp               ppp encapsulation");
        l.add(null, (b + 1) + " .        sep               sep encapsulation");
        l.add(null, (b + 1) + " .        synce             synchronous ethernet");
        l.add(null, (b + 1) + " .        ptp               precision time protocol");
        l.add(null, (b + 1) + " .        lacp              lacp");
        l.add(null, (b + 1) + " .        thread            interface thread");
        l.add(null, (b + 1) + " .        p2poec            ppp over ethernet client");
        l.add(null, (b + 1) + " .        p2poes            ppp over ethernet server");
        l.add(null, (b + 1) + " .        p2poer            ppp over ethernet relay");
        l.add(null, (b + 1) + " .        eapolc            eap over lan client");
        l.add(null, (b + 1) + " .        eapols            eap over lan server");
        l.add(null, (b + 1) + " .        nsh               nsh encapsulation");
        l.add(null, (b + 1) + " .        polka             polka encapsulation");
    }
