    ...
    public static List<String> shSecret(int typ) {
        ...
        switch (typ) {
            ...
            case 5:
                ...
                break;
            case 6:
                l.add("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
                l.add("8                                                   8");
                l.add("8  a---------------a                                8");
                l.add("8  |               |                                8");
                l.add("8  |               |                                8");
            ...
            case 10:
                l.add("                                   _----..................___");
                l.add(" __,,..,-====>       _,.--''------'' |   _____  ______________`''--._");
                l.add(" \\      `\\   __..--''                |  /::: / /::::::::::::::\\      `\\");
                l.add("  \\       `''                        | /____/ /___ ____ _____::|    .  \\");
                l.add("   \\                           ,.... |            `    `     \\_|   ( )  |");
                l.add("    `.                       /`     `.\\ ,,''`'- ,.----------.._     `   |");
                l.add("      `.                     |        ,'       `               `-.      |");
                l.add("        `-._                 \\                                    ``.. /");
            ...
            case 17:
                ...
                l.add("        |  |    '                                                '  :");
                l.add("        |  |     '             .-~~~-.               .-~-.        \\ |");
                l.add("        |  |      '          .\\\\   .//'._+_________.'.'  /_________\\|");
                l.add("        |  |___ ...'.__..--~~ .\\\\__//_.-     . . .' .'  /      :  |  `.");
                l.add("        |.-\"  .'  /                          . .' .'   /.      :_.|__.'");
                l.add("       <    .'___/                           .' .'    /|.      : .'|\\");
                l.add("        ~~--..                             .' .'     /_|.      : | | \\");
                l.add("          /_.' ~~--..__             .----.'_.'      /. . . . . . | |  |");
                l.add("                      ~~--.._______'.__.'  .'      /____________.' :  /");
                l.add("                               .'   .''.._'______.'                '-'");
                l.add("                               '---'");
                break;
            case 18:
            ...
            case 27:
                l.add("              _-o#&&*''''?d:>b\\_");
                l.add("          _o/\"`''  '',, dMF9MMMMMHo_");
                l.add("       .o&#'        `\"MbHMMMMMMMMMMMHo.");
                l.add("     .o\"\" '         vodM*$&&HMMMMMMMMMM?.");
                l.add("    ,'              $M&ood,~'`(&##MMMMMMH\\");
                l.add("   /               ,MMMMMMM#b?#bobMMMMHMMML");
                l.add("  &              ?MMMMMMMMMMMMMMMMM7MMM$R*Hk");
                l.add(" ?$.            :MMMMMMMMMMMMMMMMMMM/HMMM|`*L");
                l.add("|               |MMMMMMMMMMMMMMMMMMMMbMH'   T,");
                l.add("$H#:            `*MMMMMMMMMMMMMMMMMMMMb#}'  `?");
                l.add("]MMH#             \"\"*\"\"\"\"*#MMMMMMMMMMMMM'    -");
                l.add("MMMMMb_                   |MMMMMMMMMMMP'     :");
                l.add("HMMMMMMMHo                 `MMMMMMMMMT       .");
                l.add("?MMMMMMMMP                  9MMMMMMMM}       -");
                l.add("-?MMMMMMM                  |MMMMMMMMM?,d-    '");
                l.add(" :|MMMMMM-                 `MMMMMMMT .M|.   :");
                l.add("  .9MMM[                    &MMMMM*' `'    .");
                l.add("   :9MMk                    `MMM#\"        -");
                l.add("     &M}                     `          .-");
                l.add("      `&.                             .");
