...
public class servP4lang extends servGeneric implements prtServS, servGenFwdr {
    ...
    public final static String[] defaultL = {
        ...
        "server p4lang .*! no export-names",
        "server p4lang .*! no export-srv6",
        "server p4lang .*! no export-copp4 .*",
        "server p4lang .*! no export-copp6 .*",
        "server p4lang .*! no filter-list4 .*",
        "server p4lang .*! no filter-list6 .*",
        "server p4lang .*! no filter-map4 .*",
        "server p4lang .*! no filter-map6 .*",
        "server p4lang .*! no filter-policy4 .*",
        "server p4lang .*! no filter-policy6 .*",
        "server p4lang .*! no filter-compress4 .*",
        "server p4lang .*! no filter-compress6 .*",
        ...
        "server p4lang .*! no forwarder .* export-names",
        ...
        "server p4lang .*! no forwarder .* filter-list4 .*",
        "server p4lang .*! no forwarder .* filter-list6 .*",
        "server p4lang .*! no forwarder .* filter-map4 .*",
        "server p4lang .*! no forwarder .* filter-map6 .*",
        "server p4lang .*! no forwarder .* filter-policy4 .*",
        "server p4lang .*! no forwarder .* filter-policy6 .*",
        "server p4lang .*! no forwarder .* filter-compress4 .*",
        "server p4lang .*! no forwarder .* filter-compress6 .*",
