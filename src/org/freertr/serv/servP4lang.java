...
public class servP4lang extends servGeneric implements prtServS, servGenFwdr, ifcUp {
    ...
    public void srvHelp(userHelping l) {
        ...
        l.add(null, "4 5,.      <num>               speed in gbps, see hw vendor manual");
        l.add(servP4langUtil.toHelp(fwderrcr), "5 6,.        <num:loc>         fec, see hw vendor manual");
        l.add(servP4langUtil.toHelp(autonegs), "6 7,.          <num:loc>       autoneg, see hw vendor manual");
        l.add(servP4langUtil.toHelp(flwctrls), "7 .              <num:loc>     flowctrl, see hw vendor manual");
        ...
        l.add(null, "1 2  filter-compress4          enable compressed fib export");
        l.add(null, "2 .    <name:vrf>              vrf name");
        l.add(null, "1 2  filter-compress6          enable compressed fib export");
        l.add(null, "2 .    <name:vrf>              vrf name");
        l.add(null, "1 .  export-names              specify names to be exported");
        l.add(null, "1 .  api-stat                  count the sent api messages");
        l.add(null, "1 2  export-copp4              specify copp acl to export");
        l.add(null, "2 3    <name:vrf>              vrf name");
        l.add(null, "3 .      <name:acl>              acl name");
        l.add(null, "1 2  export-copp6              specify copp acl to export");
        l.add(null, "2 3    <name:vrf>              vrf name");
        l.add(null, "3 .      <name:acl>              acl name");
        l.add(null, "1 2  filter-list4              specify prefixes to export");
        l.add(null, "2 3    <name:vrf>              vrf name");
        l.add(null, "3 .      <name:pl>             prefix list name");
        l.add(null, "1 2  filter-list6              specify prefixes to export");
        l.add(null, "2 3    <name:vrf>              vrf name");
        l.add(null, "3 .      <name:pl>             prefix list name");
        l.add(null, "1 2  filter-map4               specify prefixes to export");
        l.add(null, "2 3    <name:vrf>              vrf name");
        l.add(null, "3 .      <name:rm>             route map name");
        l.add(null, "1 2  filter-map6               specify prefixes to export");
        l.add(null, "2 3    <name:vrf>              vrf name");
        l.add(null, "3 .      <name:rm>             route map name");
        l.add(null, "1 2  filter-policy4            specify prefixes to export");
        l.add(null, "2 3    <name:vrf>              vrf name");
        l.add(null, "3 .      <name:rpl>            route policy name");
        l.add(null, "1 2  filter-policy6            specify prefixes to export");
        l.add(null, "2 3    <name:vrf>              vrf name");
        l.add(null, "3 .      <name:rpl>            route policy name");
        ...
        l.add(lst, "2 3    <num:loc>               port number");
