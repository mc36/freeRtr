...
public class servGenList<T extends servGeneric> {
    ...
    public static void srvHelp(userHelping l, int p, String e, userHelping o) {
        ...
        l.add(cfgAll.dmnEcho.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    discard                      discard server" + e);
        l.add(cfgAll.dmnDiscard.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    chargen                      chargen server" + e);
        l.add(cfgAll.dmnCharGen.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    netflow                      netflow server" + e);
        l.add(cfgAll.dmnNetflow.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    udpfwd                       udp forwarder server" + e);
        l.add(cfgAll.dmnUdpFwd.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    upnpfwd                      upnp forwarder server" + e);
        l.add(cfgAll.dmnUpnpFwd.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    upnphub                      upnp hub server" + e);
        l.add(cfgAll.dmnUpnpHub.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    openflow                     openflow server" + e);
        l.add(cfgAll.dmnOpenflow.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    pktmux                       p4lang emulator server" + e);
        l.add(cfgAll.dmnPktmux.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        ...
        l.add(cfgAll.dmnForwarder.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    syslog                       syslog server" + e);
        l.add(cfgAll.dmnSyslog.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    loadbalancer                 loadbalancer server" + e);
        l.add(cfgAll.dmnLoadBalancer.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    multiplexer                  multiplexer server" + e);
        l.add(cfgAll.dmnMultiplexer.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    telnet                       telnet server" + e);
        l.add(cfgAll.dmnTelnet.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    xotpad                       xotpad server" + e);
        l.add(cfgAll.dmnXotpad.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    rfb                          rfb server" + e);
        l.add(cfgAll.dmnRfb.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    udptn                        udptn server" + e);
        l.add(cfgAll.dmnUdptn.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    http                         http server" + e);
        l.add(cfgAll.dmnHttp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    dhcp4                        dhcp4 server" + e);
        l.add(cfgAll.dmnDhcp4.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    dhcp6                        dhcp6 server" + e);
        l.add(cfgAll.dmnDhcp6.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    dns                          dns server" + e);
        l.add(cfgAll.dmnDns.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    lpd                          lpd server" + e);
        l.add(cfgAll.dmnLpd.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    honeypot                     honeypot server" + e);
        l.add(cfgAll.dmnHoney.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    whois                        whois server" + e);
        l.add(cfgAll.dmnWhois.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    pop3                         pop3 server" + e);
        l.add(cfgAll.dmnPop3.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    imap4                        imap4 server" + e);
        l.add(cfgAll.dmnImap4.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    smtp                         smtp server" + e);
        l.add(cfgAll.dmnSmtp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    modem                        modem server" + e);
        l.add(cfgAll.dmnModem.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    voice                        voice server" + e);
        l.add(cfgAll.dmnVoice.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    sip                          sip server" + e);
        l.add(cfgAll.dmnSip.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    ftp                          ftp server" + e);
        l.add(cfgAll.dmnFtp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    tftp                         tftp server" + e);
        l.add(cfgAll.dmnTftp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        ...
        l.add(cfgAll.dmnBmp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    irc                          irc server" + e);
        l.add(cfgAll.dmnIrc.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    dcp                          dcp server" + e);
        l.add(cfgAll.dmnDcp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    sdwan                        sdwan server" + e);
        l.add(cfgAll.dmnSdwan.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    pcep                         pcep server" + e);
        l.add(cfgAll.dmnPcep.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    ntp                          ntp server" + e);
        l.add(cfgAll.dmnNtp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    daytime                      daytime server" + e);
        l.add(cfgAll.dmnNtp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    time                         time server" + e);
        l.add(cfgAll.dmnTime.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    snmp                         snmp server" + e);
        l.add(cfgAll.dmnSnmp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    socks                        socks server" + e);
        l.add(cfgAll.dmnSocks.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    rpki                         rpki server" + e);
        l.add(cfgAll.dmnRpki.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    nrpe                         nrpe server" + e);
        l.add(cfgAll.dmnNrpe.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    prometheus                   prometheus server" + e);
        l.add(cfgAll.dmnPrometheus.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    streamingmdt                 streaming telemetry server" + e);
        l.add(cfgAll.dmnStreamingMdt.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        ...
        l.add(cfgAll.dmnVxlan.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    geneve                       geneve server" + e);
        l.add(cfgAll.dmnGeneve.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    l2f                          l2f server" + e);
        l.add(cfgAll.dmnL2f.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    l2tp2                        l2tp v2 server" + e);
        l.add(cfgAll.dmnL2tp2.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    l2tp3                        l2tp v3 server" + e);
        l.add(cfgAll.dmnL2tp3.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    etherip                      etherip server" + e);
        l.add(cfgAll.dmnEtherIp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    gre                          gre server" + e);
        l.add(cfgAll.dmnGre.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    mplsip                       mplsip server" + e);
        l.add(cfgAll.dmnMplsIp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    mplsudp                      mplsudp server" + e);
        l.add(cfgAll.dmnMplsUdp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    mplsoam                      mplsoam server" + e);
        l.add(cfgAll.dmnMplsOam.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    twamp                        twamp server" + e);
        l.add(cfgAll.dmnTwamp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    amt                          amt server" + e);
        l.add(cfgAll.dmnAmt.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        ...
        l.add(cfgAll.dmnPckOdtls.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    pckotcp                      pckotcp server" + e);
        l.add(cfgAll.dmnPckOtcp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    pckotxt                      pckotxt server" + e);
        l.add(cfgAll.dmnPckOtxt.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    gtp                          gtp server" + e);
        l.add(cfgAll.dmnGtp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    pptp                         pptp server" + e);
        l.add(cfgAll.dmnPptp.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    radius                       radius server" + e);
        l.add(cfgAll.dmnRadius.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
        l.add(null, p + "  " + (p + 1) + "    tacacs                       tacacs server" + e);
        l.add(cfgAll.dmnTacacs.listServers(), (p + 1) + "  " + n + "        <name:loc>                 name of server");
        l.addOther(o);
    }
