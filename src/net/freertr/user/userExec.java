...
public class userExec {
    ...
    private static void getHelpShowIpX(userHelping hl) {
        ...
        hl.add("4 .          [name:ifc]             name of interface");
        hl.add("3 4,.      vrf                      vrf information");
        hl.add("4 5          [name:vrf]             name of vrf");
        ...
        hl.add("4 .          <name:vrf>             name of routing table");
        ...
        hl.add("4 5,.        <name:vrf>             name of routing table");
        ...
        hl.add("4 5          <name:vrf>             specify routing table");
        ...
        hl.add("10 9,.                   <name:rm>  name of route map");
    ...
    public static void getHelpShow(userHelping hl, boolean privi) {
        ...
        hl.add("3 .        <name:aaa>            aaa list");
        hl.add("2 3      macsec                  macsec information");
        hl.add("3 .        <name:ifc>            name of interface");
        ...
        hl.add("3 .        [name:trk]            name of tracker");
        hl.add("2 3,.    mtracker                mtracker status");
        hl.add("3 .        [name:mtr]            name of mtracker");
        ...
        hl.add("4 5          <name:ifc>          name of interface");
        ...
        hl.add("3 .        <name:chk>            check name");
        hl.add("2 3,.    sensor                  sensor information");
        hl.add("3 .        <name:sns>            sensor name");
        ...
        hl.add("4 5          <name:ifc>          interface to see");
        hl.add("5 .            session           list of sessions");
        hl.add("5 .            toptalk           top talker list");
        ...
        hl.add("4 .          <name:ifc>          interface to see");
        ...
        hl.add("4 .          <name:ifc>          name of (sub)interface");
        getHelpShowIpX(hl);
    ...
    private void getHelpTelnet(userHelping hl) {
        ...
        hl.add("5 4,.          <name:vrf>        name of vrf");
        ...
        hl.add("5 4,.          <name:prx>        name of proxy profile");
        hl.add("4 5          /interface          specify interface to use");
        hl.add("5 4,.          <name:ifc>        name of interface");
        hl.add("4 5          /chat               specify chat script to use");
        hl.add("5 4,.          <name:cht>        name of chat script");
    }
    ...
    public userHelping getHelping() {
        ...
        hl.add("2 .      <name:mnu>              name of menu");
        ...
        hl.add("6 5,.            <name:vrf>      name of vrf");
        hl.add("5 6            /interface        specify interface to use");
        hl.add("6 5,.            <name:ifc>      name of interface");
        ...
        hl.add("4 3,.        <name:vrf>          name of vrf");
        hl.add("3 4        /interface            specify interface to use");
        hl.add("4 3,.        <name:ifc>          name of interface");
        ...
        hl.add("3 4        <name:sns>            name of sensor");
        hl.add("4 4,.        <name:tlm>          name of telemetry");
        ...
        hl.add("3 .        <name:lin>            name of line");
        hl.add("2 3      interface               disconnect interface");
        hl.add("3 4,.      <name:ifc>            name of interface");
        hl.add("4 .          [num]               downtime in milliseconds");
        hl.add("2 3      ipv4                    ipv4 parameters");
        hl.add("3 4        arp                   arp table");
        hl.add("4 5          <name:ifc>          interface name");
        ...
        hl.add("5 6            <name:ifc>        interface name");
        ...
        hl.add("3 4,.      <name:ifc>            name of interface");
        hl.add("4 .          [name:ifc]          name of target interface");
        hl.add(".2 3     flood                   flood packets");
        hl.add(".3 4       <name:vrf>            name of vrf");
        hl.add(".4 5         tcp                 select tcp");
        hl.add(".4 5         udp                 select udp");
        hl.add(".4 5         ludp                select ludp");
        hl.add(".4 5         dccp                select dccp");
        ...
        hl.add(".3 4       <name:vrf>            vrf name");
        hl.add(".4 5         <name:ifc>          source interface name");
        ...
        hl.add(".8 9                 <name:rm>   route map to apply");
        ...
        hl.add("3 4,.      <name:acl>            name of first acl");
        hl.add("4 .          <name:acl>          name of second acl");
        hl.add("2 3      yangsensor              create yang from sensor");
        hl.add("3 4        <file>                source");
        hl.add("4 .          <file>              target");
        ...
        hl.add("3 4        <name:trn>            name of rule");
        hl.add("4 4,.        <str>               text");
