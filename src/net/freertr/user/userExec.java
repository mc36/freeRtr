...
public class userExec {
    ...
    private static void getRouMapMtch(userHelping h, int b) {
        ...
        h.add(null, (b + 0) + " .              noextcomm          list of routes without community");
        h.add(null, (b + 0) + " " + (b + 1) + "              extcomm            list of routes with community");
        h.add(null, (b + 1) + " " + (b + 2) + ",.              <str>            community");
        h.add(null, (b + 2) + " " + (b + 2) + ",.                [str]          community");
        h.add(null, (b + 0) + " .              nolrgcomm          list of routes without community");
        h.add(null, (b + 0) + " " + (b + 1) + "              lrgcomm            list of routes with community");
        h.add(null, (b + 1) + " " + (b + 2) + ",.              <str>            community");
        h.add(null, (b + 2) + " " + (b + 2) + ",.                [str]          community");
        h.add(null, (b + 0) + " " + (b + 1) + "              aspath             list of routes with as path");
        h.add(null, (b + 1) + " " + (b + 2) + ",.              <str>            as path regular expression");
        h.add(null, (b + 2) + " " + (b + 2) + ",.                [str]          as path regular expression");
        h.add(null, (b + 0) + " " + (b + 1) + "              distance           list of routes with distance");
        h.add(null, (b + 1) + " .                <str>            int matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              pathlen            list of routes with path length");
        h.add(null, (b + 1) + " .                <str>            int matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              unknowns           list of routes with unknown attributes");
        h.add(null, (b + 1) + " .                <str>            int matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              asend              list of routes with path ending");
        h.add(null, (b + 1) + " .                <str>            int matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              asbeg              list of routes with path beginning");
        h.add(null, (b + 1) + " .                <str>            int matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              asmid              list of routes with path middle");
        h.add(null, (b + 1) + " .                <str>            int matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              locpref            list of routes with locpref");
        h.add(null, (b + 1) + " .                <str>            int matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              validity           list of routes with validity");
        h.add(null, (b + 1) + " .                <str>            int matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              aigp               list of routes with aigp");
        h.add(null, (b + 1) + " .                <str>            int matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              bandwidth          list of routes with bandwidth");
        h.add(null, (b + 1) + " .                <str>            int matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              origin             list of routes with origin");
        h.add(null, (b + 1) + " .                <str>            int matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              metric             list of routes with metric");
        h.add(null, (b + 1) + " .                <str>            int matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              tag                list of routes with tag");
        h.add(null, (b + 1) + " .                <str>            int matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              rd                 list of routes with rd");
        h.add(null, (b + 1) + " .                <str>            int matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              nexthop            list of routes with nexthop");
        h.add(null, (b + 1) + " .                <str>            address matcher");
        h.add(null, (b + 0) + " " + (b + 1) + "              network            list of routes from network");
    ...
    public static void getHelpShow(userHelping hl, boolean privi) {
        ...
        hl.add(null, "5 .            [num]             forwarder number");
        hl.add(null, "4 5,.        backplane-topology  backplane topology");
        hl.add(null, "5 .            [num]             forwarder number");
        hl.add(null, "4 5,.        backplane-tree      backplane tree");
        hl.add(null, "5 .            [num]             forwarder number");
        hl.add(null, "4 5,.        backplane-graph     backplane graph");
        hl.add(null, "5 .            [num]             forwarder number");
        hl.add(null, "4 5,.        backplane-route     backplane routes");
    ...
    public userHelping getHelping() {
        ...
        hl.addOther(hlp);
        hl.add(null, "2 3      getperm                      get file permissions");
