...
public class userConfig {
    ...
    private void getHelpGlobal(userHelping l) {
        ...
        l.add("2  .    <name:ses>                   name of session");
        l.add("1  2  check                          check parameters");
        l.add("2  .    <name:chk>                   name of check");
        l.add("1  2  sensor                         sensor parameters");
        l.add("2  .    <name:sns>                   name of sensor");
        ...
        l.add("5  6          <name:ifc>             target interface");
        l.add("6  4,.          <addr>               target mac address");
        l.add("4  5        route                    route normally");
        l.add("5  4,.        <name:vrf>             target vrf");
        ...
        l.add("3  .      <name:prx>                 name of profile");
        ...
        l.add("3  .      <name:scr>                 name of script");
        ...
        l.add("3  4      <name:vrf>                 name of routing table");
        ...
        l.add("3  4      <name:pl4>                 name of address pool");
        ...
        getHelpIpX(l);
        l.add("2  3    pool                         configure address pool");
        l.add("3  4      <name:pl6>                 name of address pool");
        l.add("4  5        <first>                  first address in pool");
        l.add("5  6          <inc>                  increment in address format");
        l.add("6  .            <num>                number of addresses");
        l.add("1  2  scheduler                      configure a scheduler");
        l.add("2  .    <name:sch>                   name of scheduler");
        l.add("1  2  script                         configure a script");
        l.add("2  .    <name:scr>                   name of script");
        l.add("1  2  tracker                        configure a tracker");
        l.add("2  .    <name:trk>                   name of tracker");
        l.add("1  2  mtracker                       configure a mtracker");
        l.add("2  .    <name:mtr>                   name of mtracker");
        ...
        l.add("3  4      <name:dsa>                 name of key");
        l.add("4  5        import                   import key");
        l.add("5  .          <text>                 base64 encoded private key");
        l.add("4  5        external                 load key from file");
        l.add("5  .          <text>                 file name");
        ...
        l.add("3  4      <name:ecd>                 name of key");
        l.add("4  5        import                   import key");
        l.add("5  .          <text>                 base64 encoded private key");
        l.add("4  5        external                 load key from file");
        l.add("5  .          <text>                 file name");
        ...
        l.add("5  6          rsa                    rsa key");
        l.add("6  .            <name:rsa>           name of key");
        l.add("5  6          dsa                    dsa key");
        l.add("6  .            <name:dsa>           name of key");
        l.add("5  6          ecdsa                  ecdsa key");
        l.add("6  .            <name:ecd>           name of key");
        l.add("1  2  xconnect                       define one protocol cross connection");
        l.add("2  .    <name:xcn>                   name of connection");
        l.add("1  2  connect                        define one interface cross connection");
        l.add("2  .    <name:cnn>                   name of connection");
        l.add("1  2  menu                           define one menu");
        l.add("2  .    <name:mnu>                   name of menu");
    ...
    private void getHelpIpX(userHelping l) {
        ...
        l.add("7  8              <name:acl>               access list name");
        l.add("8  9                interface              translated interface");
        l.add("9  .                  <name:ifc>           translated interface");
        ...
        l.add("8  9                <name:ifc>             original interface");
        l.add("9  10                 interface            translated interface");
        l.add("10 .                    <name:ifc>         translated interface");
        ...
        l.add("11 12                     <name:ifc>       translated interface");
        ...
        l.add("9  10                 <name:ifc>           original interface");
        l.add("10 11                   <orig>             original port");
        l.add("11 12                     interface        translated interface");
        l.add("12 13                       <name:ifc>     translated interface");
