...
public class rtrLsrpIface implements Comparator<rtrLsrpIface>, Runnable, prtServP {
    ...
    public static void routerGetHelp(userHelping l) {
        ...
        l.add(null, "4 .         dynamic-metric          dynamic peer metric");
        ...
        l.add(null, "6 7             <name>              rsa key");
        l.add(null, "7 8               <name>            dsa key");
        l.add(null, "8 9                 <name>          ecdsa key");
        l.add(null, "9 10                  <name>        rsa certificate");
        l.add(null, "10 11                   <name>      dsa certificate");
        l.add(null, "11 .                      <name>    ecdsa certificate");
