...
public class rtrOlsrIface implements Comparator<rtrOlsrIface> {
    ...
    public void register2udp() {
        ...
        lower.udpCore.packetListen(lower, iface, rtrOlsr.port, null, 0, "olsr", null, -1);
    ...
    public static void routerGetHelp(userHelping l) {
        l.add(null, "4 .         enable                  enable/disable olsr updates");
        ...
        l.add(null, "4 .         lq-mode                 advertise with lq packets");
        l.add(null, "4 5         distance                administrative distance of routes");
        l.add(null, "5 .           <num>                 set administrative distance");
        l.add(null, "4 5         willingness             willingness to forward");
        l.add(null, "5 .           <num>                 set willingness");
        l.add(null, "4 5         metric-in               interface incoming metric");
        l.add(null, "5 .           <num>                 metric");
        l.add(null, "4 5         metric-out              interface outgoing metric");
        l.add(null, "5 .           <num>                 metric");
        l.add(null, "4 5         packet-timer            inter packet gap time");
        l.add(null, "5 .           <num>                 time in ms");
        l.add(null, "4 5         hello-timer             time between hellos");
        l.add(null, "5 .           <num>                 time in ms");
        l.add(null, "4 5         hello-hold              hello hold time");
        l.add(null, "5 .           <num>                 time in ms");
        l.add(null, "4 5         advertise-timer         time between advertisements");
        l.add(null, "5 .           <num>                 time in ms");
        l.add(null, "4 5         advertise-hold          advertisement hold time");
        l.add(null, "5 .           <num>                 time in ms");
