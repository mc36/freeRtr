...
public class rtrBgp extends ipRtr implements prtServS, Runnable {
    ...
    public void routerGetHelp(userHelping l) {
        ...
        l.add(null, "2 3     <name>                    access list name");
        ...
        l.add(null, "3 4       <name>                  proxy profile");
        ...
        l.add(null, "3 .       <name>                  select source to advertise");
        ...
        l.add(null, "3 .       <name>                  name of policy map");
        ...
        l.add(null, "4 .         <name>                select source to advertise");
        ...
        l.add(null, "4 .         <name>                name of policy map");
