...
public class rtrIsisIface implements Comparator<rtrIsisIface>, ifcUp {
    ...
    public static void routerGetHelp(userHelping l) {
        ...
        l.add(null, "4 .         other-enable              enable other protocol processing");
        l.add(null, "4 5         circuit                   set circuit type");
        l.add(null, "5 .           level1                  level-1 circuit");
        l.add(null, "5 .           level2                  level-2 circuit");
        l.add(null, "5 .           both                    level-1 and level-2 circuit");
        l.add(null, "4 5         network                   set network type");
        ...
        l.add(null, "4 .         raw-encapsulation         use non-llc encapsulation");
        ...
        l.add(null, "4 .         other-unsuppress-prefix   do advertise other interface");
        l.add(null, "4 .         other-suppress-address    do not advertise other interface");
