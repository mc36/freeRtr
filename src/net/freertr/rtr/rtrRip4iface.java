...
public class rtrRip4iface implements Comparator<rtrRip4iface> {
    ...
    public void register2udp() {
        ...
        lower.udpCore.packetListen(lower, iface, rtrRip4.port, null, 0, "rip", null, -1, -1);
        conn = lower.udpCore.packetConnect(lower, iface, rtrRip4.port, adr, rtrRip4.port, "rip", null, -1, -1);
        if (conn == null) {
            return;
        }
        conn.timeout = 0;
