...
public class cfgIfc implements Comparator<cfgIfc>, cfgGeneric {
    ...
    public final static String[] defaultL = {
        ...
        "interface .*! no ipv[4|6] gateway-labeled",
        "interface .*! no ipv[4|6] gateway-prefix",
        "interface .*! no ipv[4|6] gateway-map",
        "interface .*! no ipv[4|6] gateway-policy",
        ...
        "interface .*! no router pvrp[4|6] .* dynamic-forbid",
        ...
        "interface .*! no router lsrp[4|6] .* dynamic-forbid",
