...
public class cfgIfc implements Comparator<cfgIfc>, cfgGeneric {
    ...
    public final static String[] defaultL = {
        ...
        "interface .*! no router ospf[46] .* dynamic-metric",
        "interface .*! router ospf[46] .* dynamic-time 60000",
        "interface .*! router ospf[46] .* dynamic-size 5",
        "interface .*! router ospf[46] .* dynamic-minimum 1",
        "interface .*! router ospf[46] .* dynamic-maximum 65530",
        "interface .*! router ospf[46] .* dynamic-divisor 1",
        "interface .*! router ospf[46] .* dynamic-multiply 1",
        "interface .*! router ospf[46] .* dynamic-ignore 0",
        ...
        "interface .*! no router pvrp[46] .* dynamic-metric",
        "interface .*! no router pvrp[46] .* dynamic-forbid",
        ...
        "interface .*! router pvrp[46] .* dynamic-time 60000",
        "interface .*! router pvrp[46] .* dynamic-size 5",
        "interface .*! router pvrp[46] .* dynamic-minimum 1",
        "interface .*! router pvrp[46] .* dynamic-maximum 100000",
        "interface .*! router pvrp[46] .* dynamic-divisor 1",
        "interface .*! router pvrp[46] .* dynamic-multiply 1",
        "interface .*! router pvrp[46] .* dynamic-ignore 0",
        "interface .*! router pvrp[46] .* dynamic-skip-min 0",
        "interface .*! router pvrp[46] .* dynamic-skip-max 0",
        "interface .*! router pvrp[46] .* dynamic-algo minimum",
        ...
        "interface .*! no router lsrp[46] .* dynamic-metric",
        "interface .*! no router lsrp[46] .* dynamic-forbid",
        ...
        "interface .*! router lsrp[46] .* dynamic-time 60000",
        "interface .*! router lsrp[46] .* dynamic-size 5",
        "interface .*! router lsrp[46] .* dynamic-minimum 1",
        "interface .*! router lsrp[46] .* dynamic-maximum 100000",
        "interface .*! router lsrp[46] .* dynamic-divisor 1",
        "interface .*! router lsrp[46] .* dynamic-multiply 1",
        "interface .*! router lsrp[46] .* dynamic-ignore 0",
        "interface .*! router lsrp[46] .* dynamic-skip-min 0",
        "interface .*! router lsrp[46] .* dynamic-skip-max 0",
        "interface .*! router lsrp[46] .* dynamic-algo minimum",
        // eigrp
        ...
        "interface .*! no router isis[46] .* dynamic-metric",
        "interface .*! router isis[46] .* dynamic-time 60000",
        "interface .*! router isis[46] .* dynamic-size 5",
        "interface .*! router isis[46] .* dynamic-minimum 1",
        "interface .*! router isis[46] .* dynamic-maximum 16777210",
        "interface .*! router isis[46] .* dynamic-divisor 1",
        "interface .*! router isis[46] .* dynamic-multiply 1",
        "interface .*! router isis[46] .* dynamic-ignore 0",
        "interface .*! router isis[46] .* dynamic-skip-min 0",
        "interface .*! router isis[46] .* dynamic-skip-max 0",
        "interface .*! router isis[46] .* dynamic-algo minimum",
        // vlan
