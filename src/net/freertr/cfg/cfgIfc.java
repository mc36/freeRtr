...
public class cfgIfc implements Comparator<cfgIfc>, cfgGeneric {
    ...
    public final static String[] defaultL = {
        ...
        "interface .*! router pvrp[4|6] .* dynamic-size 1",
        ...
        "interface .*! router pvrp[4|6] .* dynamic-mode none",
        ...
        "interface .*! router lsrp[4|6] .* dynamic-size 1",
        ...
        "interface .*! router lsrp[4|6] .* dynamic-mode none",
        // eigrp
