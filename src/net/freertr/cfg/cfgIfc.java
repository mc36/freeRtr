...
public class cfgIfc implements Comparator<cfgIfc>, cfgGeneric {
    ...
    public final static String[] defaultL = {
        ...
        // ip
        "interface .*! no ipv[46] address",
        "interface .*! no ipv[46] enable",
        "interface .*! no ipv[46] reassembly",
        "interface .*! no ipv[46] fragmentation",
        "interface .*! no ipv[46] pmtud-in",
        "interface .*! no ipv[46] pmtud-out",
        "interface .*! no ipv[46] redirection",
        "interface .*! ipv[46] unreachables",
        "interface .*! no ipv[46] unreach-source",
        "interface .*! no ipv[46] propagate-ttl-always",
        "interface .*! ipv[46] propagate-ttl-allow",
        ...
        "interface .*! no ipv[46] gateway-map",
        "interface .*! no ipv[46] gateway-policy",
        "interface .*! no ipv[46] access-group-in",
        "interface .*! no ipv[46] access-group-out",
        "interface .*! no ipv[46] access-group-common-in",
        "interface .*! no ipv[46] access-group-common-out",
        ...
        "interface .*! ipv[46] host-retry 180000",
        "interface .*! no ipv[46] proxy-remote",
        "interface .*! no ipv[46] proxy-local",
        "interface .*! no ipv[46] proxy-filter",
        "interface .*! no ipv[46] tcp-mss-in",
        "interface .*! no ipv[46] tcp-mss-out",
        "interface .*! no ipv[46] hsrp address",
        "interface .*! no ipv[46] netflow-rx",
        "interface .*! no ipv[46] netflow-tx",
        "interface .*! ipv[46] hsrp group 0",
        "interface .*! ipv[46] hsrp password \\$v10\\$Y2lzY28=",
        "interface .*! ipv4 hsrp mac-address 0000.0c9f.f000",
        "interface .*! ipv6 hsrp mac-address 0005.73a0.0000",
        "interface .*! ipv[46] hsrp version 2",
        "interface .*! ipv[46] hsrp timer 3000 10000",
        "interface .*! ipv[46] hsrp priority 100",
        "interface .*! no ipv[46] hsrp preempt",
        "interface .*! no ipv[46] hsrp bfd",
        "interface .*! no ipv[46] hsrp tracker",
        "interface .*! no ipv[46] vrrp address",
        "interface .*! ipv[46] vrrp group 0",
        "interface .*! ipv4 vrrp mac-address 0000.5e00.0100",
        "interface .*! ipv6 vrrp mac-address 0000.5e00.0200",
        "interface .*! ipv[46] vrrp version 3",
        "interface .*! ipv[46] vrrp timer 1000 3000",
        "interface .*! ipv[46] vrrp priority 100",
        "interface .*! no ipv[46] vrrp tracker",
        "interface .*! no ipv[46] vrrp bfd",
        "interface .*! no ipv[46] pool",
        "interface .*! no ipv[46] inspect",
        ...
        "interface .*! no ipv[46] pim enable",
        "interface .*! no ipv[46] pim bfd",
        "interface .*! no ipv[46] pim join-source",
        "interface .*! ipv[46] pim allow-rx",
        "interface .*! ipv[46] pim allow-tx",
        "interface .*! ipv[46] pim bier-tunnel 0",
        "interface .*! ipv[46] pim packet-timer 20",
        "interface .*! ipv[46] pim priority 1",
        "interface .*! ipv[46] pim hello-time 30000",
        "interface .*! no ipv[46] multicast mldp-enable",
        ...
        "interface .*! no router babel[46] .* default-originate",
        "interface .*! no router babel[46] .* suppress-prefix",
        "interface .*! no router babel[46] .* unsuppress-prefix",
        "interface .*! router babel[46] .* verify-source",
        "interface .*! router babel[46] .* distance 130",
        "interface .*! router babel[46] .* metric-in 100",
        "interface .*! router babel[46] .* metric-out 0",
        "interface .*! router babel[46] .* packet-timer 20",
        "interface .*! router babel[46] .* update-timer 20000",
        "interface .*! no router babel[46] .* prefix-list-in",
        "interface .*! no router babel[46] .* prefix-list-out",
        "interface .*! no router babel[46] .* route-map-in",
        "interface .*! no router babel[46] .* route-map-out",
        "interface .*! no router babel[46] .* route-policy-in",
        "interface .*! no router babel[46] .* route-policy-out",
        // olsr
        "interface .*! no router olsr[46] .* bfd",
        "interface .*! router olsr[46] .* split-horizon",
        "interface .*! router olsr[46] .* lq-mode",
        "interface .*! no router olsr[46] .* default-originate",
        "interface .*! no router olsr[46] .* suppress-prefix",
        "interface .*! no router olsr[46] .* unsuppress-prefix",
        "interface .*! router olsr[46] .* verify-source",
        "interface .*! router olsr[46] .* distance 140",
        "interface .*! router olsr[46] .* willingness 7",
        "interface .*! router olsr[46] .* metric-in 1",
        "interface .*! router olsr[46] .* metric-out 0",
        "interface .*! router olsr[46] .* packet-timer 20",
        "interface .*! router olsr[46] .* hello-timer 5000",
        "interface .*! router olsr[46] .* hello-hold 15000",
        "interface .*! router olsr[46] .* advertise-timer 30000",
        "interface .*! router olsr[46] .* advertise-hold 90000",
        "interface .*! no router olsr[46] .* prefix-list-in",
        "interface .*! no router olsr[46] .* prefix-list-out",
        "interface .*! no router olsr[46] .* route-map-in",
        "interface .*! no router olsr[46] .* route-map-out",
        "interface .*! no router olsr[46] .* route-policy-in",
        "interface .*! no router olsr[46] .* route-policy-out",
        // rip
        "interface .*! router rip[46] .* allow-rx",
        "interface .*! router rip[46] .* allow-tx",
        "interface .*! no router rip[46] .* bfd",
        "interface .*! router rip[46] .* verify-source",
        "interface .*! router rip[46] .* poison-reverse",
        "interface .*! router rip[46] .* split-horizon",
        "interface .*! no router rip[46] .* default-originate",
        "interface .*! no router rip[46] .* suppress-prefix",
        "interface .*! no router rip[46] .* unsuppress-prefix",
        "interface .*! router rip[46] .* distance 120",
        "interface .*! router rip[46] .* metric-in 0",
        "interface .*! router rip[46] .* metric-out 1",
        "interface .*! router rip[46] .* packet-timer 20",
        "interface .*! router rip[46] .* update-timer 30000",
        "interface .*! router rip[46] .* hold-time 180000",
        "interface .*! router rip[46] .* flush-time 240000",
        "interface .*! no router rip[46] .* password",
        "interface .*! no router rip[46] .* prefix-list-in",
        "interface .*! no router rip[46] .* prefix-list-out",
        "interface .*! no router rip[46] .* route-map-in",
        "interface .*! no router rip[46] .* route-map-out",
        "interface .*! no router rip[46] .* route-policy-in",
        "interface .*! no router rip[46] .* route-policy-out",
        // ospf
        "interface .*! no router ospf[46] .* passive",
        "interface .*! router ospf[46] .* network point2point",
        "interface .*! no router ospf[46] .* bfd",
        ...
        "interface .*! router ospf[46] .* instance 0",
        "interface .*! router ospf[46] .* cost 10",
        "interface .*! router ospf[46] .* priority 0",
        "interface .*! router ospf[46] .* hello-time 10000",
        "interface .*! router ospf[46] .* dead-time 40000",
        "interface .*! router ospf[46] .* retransmit-time 3000",
        "interface .*! no router ospf[46] .* traffeng suppress",
        "interface .*! router ospf[46] .* traffeng metric 10",
        "interface .*! router ospf[46] .* traffeng bandwidth 100000000",
        "interface .*! router ospf[46] .* traffeng affinity 0",
        "interface .*! router ospf[46] .* traffeng srlg 0",
        "interface .*! no router ospf[46] .* segrout index",
        "interface .*! no router ospf[46] .* segrout node",
        "interface .*! no router ospf[46] .* segrout pop",
        "interface .*! no router ospf[46] .* bier index",
        "interface .*! no router ospf[46] .* bier subdomain",
        "interface .*! no router ospf[46] .* dynamic-metric mode",
        "interface .*! router ospf[46] .* dynamic-metric time 60000",
        "interface .*! router ospf[46] .* dynamic-metric size 5",
        "interface .*! router ospf[46] .* dynamic-metric minimum 1",
        "interface .*! router ospf[46] .* dynamic-metric maximum 65530",
        "interface .*! router ospf[46] .* dynamic-metric divisor 1",
        "interface .*! router ospf[46] .* dynamic-metric multiply 1",
        "interface .*! router ospf[46] .* dynamic-metric ignore 0",
        "interface .*! router ospf[46] .* dynamic-metric skip-min 0",
        "interface .*! router ospf[46] .* dynamic-metric skip-max 0",
        "interface .*! router ospf[46] .* dynamic-metric algo minimum",
        // rift
        ...
        "interface .*! no router rift[46] .* dynamic-metric mode",
        "interface .*! router rift[46] .* dynamic-metric time 60000",
        "interface .*! router rift[46] .* dynamic-metric size 5",
        "interface .*! router rift[46] .* dynamic-metric minimum 1",
        "interface .*! router rift[46] .* dynamic-metric maximum 65530",
        "interface .*! router rift[46] .* dynamic-metric divisor 1",
        "interface .*! router rift[46] .* dynamic-metric multiply 1",
        "interface .*! router rift[46] .* dynamic-metric ignore 0",
        "interface .*! router rift[46] .* dynamic-metric skip-min 0",
        "interface .*! router rift[46] .* dynamic-metric skip-max 0",
        "interface .*! router rift[46] .* dynamic-metric algo minimum",
        // pvrp
        "interface .*! router pvrp[46] .* split-horizon",
        "interface .*! no router pvrp[46] .* passive",
        "interface .*! no router pvrp[46] .* dump",
        "interface .*! no router pvrp[46] .* accept-metric",
        "interface .*! no router pvrp[46] .* dynamic-metric mode",
        "interface .*! no router pvrp[46] .* dynamic-metric forbid",
        ...
        "interface .*! no router pvrp[46] .* unsuppress-prefix",
        "interface .*! router pvrp[46] .* verify-source",
        "interface .*! no router pvrp[46] .* password",
        "interface .*! no router pvrp[46] .* disable-password",
        "interface .*! no router pvrp[46] .* encryption",
        "interface .*! router pvrp[46] .* distance 80",
        "interface .*! router pvrp[46] .* metric-in 10",
        "interface .*! router pvrp[46] .* metric-out 0",
        "interface .*! router pvrp[46] .* hello-time 5000",
        "interface .*! router pvrp[46] .* dead-time 15000",
        "interface .*! router pvrp[46] .* pmtud 0 0 0",
        "interface .*! router pvrp[46] .* sending-tos -1",
        "interface .*! router pvrp[46] .* sending-ttl -1",
        "interface .*! router pvrp[46] .* dynamic-metric time 60000",
        "interface .*! router pvrp[46] .* dynamic-metric size 5",
        "interface .*! router pvrp[46] .* dynamic-metric minimum 1",
        "interface .*! router pvrp[46] .* dynamic-metric maximum 100000",
        "interface .*! router pvrp[46] .* dynamic-metric divisor 1",
        "interface .*! router pvrp[46] .* dynamic-metric multiply 1",
        "interface .*! router pvrp[46] .* dynamic-metric ignore 0",
        "interface .*! router pvrp[46] .* dynamic-metric skip-min 0",
        "interface .*! router pvrp[46] .* dynamic-metric skip-max 0",
        "interface .*! router pvrp[46] .* dynamic-metric algo minimum",
        "interface .*! no router pvrp[46] .* label-in",
        "interface .*! no router pvrp[46] .* label-out",
        "interface .*! no router pvrp[46] .* prefix-list-in",
        "interface .*! no router pvrp[46] .* prefix-list-out",
        "interface .*! no router pvrp[46] .* route-map-in",
        "interface .*! no router pvrp[46] .* route-map-out",
        "interface .*! no router pvrp[46] .* route-policy-in",
        "interface .*! no router pvrp[46] .* route-policy-out",
        // lsrp
        "interface .*! no router lsrp[46] .* passive",
        "interface .*! no router lsrp[46] .* dump",
        "interface .*! no router lsrp[46] .* accept-metric",
        "interface .*! no router lsrp[46] .* dynamic-metric mode",
        "interface .*! no router lsrp[46] .* dynamic-metric forbid",
        "interface .*! no router lsrp[46] .* bfd",
        "interface .*! no router lsrp[46] .* segrout",
        "interface .*! no router lsrp[46] .* bier",
        "interface .*! no router lsrp[46] .* stub",
        "interface .*! no router lsrp[46] .* unstub",
        "interface .*! no router lsrp[46] .* suppress-prefix",
        "interface .*! no router lsrp[46] .* unsuppress-prefix",
        "interface .*! router lsrp[46] .* verify-source",
        "interface .*! no router lsrp[46] .* password",
        "interface .*! no router lsrp[46] .* disable-password",
        "interface .*! no router lsrp[46] .* encryption",
        "interface .*! no router lsrp[46] .* database-filter",
        "interface .*! router lsrp[46] .* split-horizon",
        "interface .*! router lsrp[46] .* metric 10",
        "interface .*! router lsrp[46] .* affinity 0",
        "interface .*! router lsrp[46] .* srlg 0",
        "interface .*! router lsrp[46] .* hello-time 5000",
        "interface .*! router lsrp[46] .* dead-time 15000",
        "interface .*! router lsrp[46] .* pmtud 0 0 0",
        "interface .*! router lsrp[46] .* sending-tos -1",
        "interface .*! router lsrp[46] .* sending-ttl -1",
        "interface .*! router lsrp[46] .* dynamic-metric time 60000",
        "interface .*! router lsrp[46] .* dynamic-metric size 5",
        "interface .*! router lsrp[46] .* dynamic-metric minimum 1",
        "interface .*! router lsrp[46] .* dynamic-metric maximum 100000",
        "interface .*! router lsrp[46] .* dynamic-metric divisor 1",
        "interface .*! router lsrp[46] .* dynamic-metric multiply 1",
        "interface .*! router lsrp[46] .* dynamic-metric ignore 0",
        "interface .*! router lsrp[46] .* dynamic-metric skip-min 0",
        "interface .*! router lsrp[46] .* dynamic-metric skip-max 0",
        "interface .*! router lsrp[46] .* dynamic-metric algo minimum",
        // eigrp
        "interface .*! router eigrp[46] .* split-horizon",
        "interface .*! no router eigrp[46] .* passive",
        "interface .*! no router eigrp[46] .* bfd",
        "interface .*! no router eigrp[46] .* default-originate",
        "interface .*! no router eigrp[46] .* suppress-prefix",
        "interface .*! no router eigrp[46] .* unsuppress-prefix",
        "interface .*! router eigrp[46] .* verify-source",
        "interface .*! router eigrp[46] .* delay-in 10",
        "interface .*! router eigrp[46] .* delay-out 0",
        "interface .*! router eigrp[46] .* distance 90",
        "interface .*! router eigrp[46] .* hello-time 5000",
        "interface .*! router eigrp[46] .* dead-time 15000",
        "interface .*! no router eigrp[46] .* prefix-list-in",
        "interface .*! no router eigrp[46] .* prefix-list-out",
        "interface .*! no router eigrp[46] .* route-map-in",
        "interface .*! no router eigrp[46] .* route-map-out",
        "interface .*! no router eigrp[46] .* route-policy-in",
        "interface .*! no router eigrp[46] .* route-policy-out",
        // isis
        "interface .*! no router isis[46] .* passive",
        "interface .*! no router isis[46] .* other-enable",
        "interface .*! no router isis[46] .* raw-encapsulation",
        "interface .*! router isis[46] .* network point2point",
        "interface .*! no router isis[46] .* bfd",
        "interface .*! router isis[46] .* suppress-address",
        "interface .*! no router isis[46] .* suppress-prefix",
        "interface .*! no router isis[46] .* unsuppress-prefix",
        "interface .*! router isis[46] .* other-suppress-address",
        "interface .*! no router isis[46] .* other-suppress-prefix",
        "interface .*! no router isis[46] .* other-unsuppress-prefix",
        "interface .*! router isis[46] .* verify-source",
        "interface .*! no router isis[46] .* send-csnp",
        "interface .*! no router isis[46] .* password",
        "interface .*! router isis[46] .* authen-type clear",
        "interface .*! router isis[46] .* metric 10",
        "interface .*! router isis[46] .* priority 64",
        "interface .*! router isis[46] .* hello-time 10000",
        "interface .*! router isis[46] .* dead-time 30000",
        "interface .*! router isis[46] .* retransmit-time 3000",
        "interface .*! no router isis[46] .* traffeng suppress",
        "interface .*! router isis[46] .* traffeng metric 10",
        "interface .*! router isis[46] .* traffeng bandwidth 100000000",
        "interface .*! router isis[46] .* traffeng affinity 0",
        "interface .*! router isis[46] .* traffeng srlg 0",
        "interface .*! no router isis[46] .* segrout index",
        "interface .*! no router isis[46] .* segrout other-index",
        "interface .*! no router isis[46] .* segrout node",
        "interface .*! no router isis[46] .* segrout pop",
        "interface .*! no router isis[46] .* bier index",
        "interface .*! no router isis[46] .* bier other-index",
        "interface .*! no router isis[46] .* bier subdomain",
        "interface .*! no router isis[46] .* bier other-subdomain",
        "interface .*! no router isis[46] .* dynamic-metric mode",
        "interface .*! router isis[46] .* dynamic-metric time 60000",
        "interface .*! router isis[46] .* dynamic-metric size 5",
        "interface .*! router isis[46] .* dynamic-metric minimum 1",
        "interface .*! router isis[46] .* dynamic-metric maximum 16777210",
        "interface .*! router isis[46] .* dynamic-metric divisor 1",
        "interface .*! router isis[46] .* dynamic-metric multiply 1",
        "interface .*! router isis[46] .* dynamic-metric ignore 0",
        "interface .*! router isis[46] .* dynamic-metric skip-min 0",
        "interface .*! router isis[46] .* dynamic-metric skip-max 0",
        "interface .*! router isis[46] .* dynamic-metric algo minimum",
        // vlan
        ...
        "interface .*! ppp retry 10",
        "interface .*! ppp reqrst 5",
        ...
        "interface .*! no ppp ip4cp optional",
        ...
        "interface .*! no ppp ip6cp optional",
    ...
    public void getHelp(userHelping l) {
        ...
        l.add(null, "2 3     dontfrag                    dont fragment bit, -1 to map out");
        l.add(null, "3 .       <num>                     value of tos field");
