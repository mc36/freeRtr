...
public class cfgRtr implements Comparator<cfgRtr>, cfgGeneric {
    ...
    public final static String[] defaultL = {
        ...
        "router bgp[46] .*! afi-ctp .* distance -1",
        "router bgp[46] .*! no afi-ctp .* default-originate",
        "router bgp[46] .*! no afi-ctp .* flowspec-advert",
        "router bgp[46] .*! no afi-ctp .* flowspec-install",
        "router bgp[46] .*! no afi-ctp .* mvpn",
        "router bgp[46] .*! afi-octp .* distance -1",
        "router bgp[46] .*! no afi-octp .* default-originate",
        "router bgp[46] .*! no afi-octp .* flowspec-advert",
        "router bgp[46] .*! no afi-octp .* flowspec-install",
        "router bgp[46] .*! no afi-octp .* mvpn",
