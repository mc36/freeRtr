...
import net.freertr.clnt.clntSip;
...
public class cfgDial implements Comparator<cfgDial>, cfgGeneric {
    ...
    public void getHelp(userHelping l) {
        ...
        l.add(null, "1 2    skip-peers-in           skip dial peers incoming");
        l.add(null, "2 .      <str>                 comma separated peers");
        l.add(null, "1 2    skip-peers-out          skip dial peers outgoing");
        l.add(null, "2 .      <str>                 comma separated peers");
        l.add(null, "1 2    allow-peers-in          allow dial peers incoming");
        l.add(null, "2 .      <str>                 comma separated peers");
        l.add(null, "1 2    allow-peers-out         allow dial peers outgoing");
        l.add(null, "2 .      <str>                 comma separated peers");
        l.add(null, "1 2    match-calling           match calling string");
        l.add(null, "2 2,.    <str>                 regular expression");
        l.add(null, "1 2    match-called            match called string");
        l.add(null, "2 2,.    <str>                 regular expression");
        l.add(null, "1 2    translate-in-calling    translate incoming calling string");
        l.add(null, "2 .      <name>                rule name");
        l.add(null, "1 2    translate-in-called     translate incoming called string");
        l.add(null, "2 .      <name>                rule name");
        ...
        l.add(null, "2 .      <name>                rule name");
        l.add(null, "1 2    prematch-calling        prematch translate outgoing calling string");
        l.add(null, "2 .      <name>                rule name");
        l.add(null, "1 2    prematch-called         prematch translate outgoing called string");
        l.add(null, "2 .      <name>                rule name");
        l.add(null, "1 2    vrf                     vrf to use");
        ...
        l.add(null, "2 .      sip-connect           sip over tcp as client");
        l.add(null, "1 2    direction               set peer direction");
        l.add(null, "2 .      in                    inbound");
        l.add(null, "2 .      out                   outbound");
        l.add(null, "2 .      both                  in and out");
        l.add(null, "2 .      none                  disabled");
        l.add(null, "1 .    log                     log calls");
        l.add(null, "1 2    max-calls-in            maximum in calls allowed");
        l.add(null, "2 .      <num>                 limit");
        l.add(null, "1 2    max-calls-out           maximum out calls allowed");
        l.add(null, "2 .      <num>                 limit");
        l.add(null, "1 2    history                 history size");
        l.add(null, "2 .      <num>                 limit");
        l.add(null, "1 2    keepalive               keepalive to peer");
        l.add(null, "2 .      <num>                 time in ms");
        l.add(null, "1 2    register                register to peer");
        l.add(null, "2 .      <num>                 time in ms");
        l.add(null, "1 2    subscribe               subscribe to peer");
        l.add(null, "2 .      <num>                 time in ms");
        l.add(null, "1 2    options                 options to peer");
        l.add(null, "2 .      <num>                 time in ms");
        l.add(null, "1 2    port-local              local port");
        l.add(null, "2 .      <num>                 port number");
        l.add(null, "1 2    port-remote             remote port");
        l.add(null, "2 .      <num>                 port number");
