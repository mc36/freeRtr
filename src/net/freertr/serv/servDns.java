...
public class servDns extends servGeneric implements prtServS {
    ...
    public void srvHelp(userHelping l) {
        ...
        l.add(null, " 3 4     <name>              domain name");
        l.add(null, " 4 5   soa                   specify a start of authority");
        l.add(null, " 5 6     <ns>                name server");
        l.add(null, " 6 7       <email>           email of author");
        l.add(null, " 7 8         <seq>           sequence number");
        l.add(null, " 8 9           <refresh>     refresh interval");
        l.add(null, " 9 10             <retry>    retry interval");
        l.add(null, "10 11               <expire> expire interval");
        l.add(null, "11 .                  <min>  minimum ttl value");
        l.add(null, " 4 5   hinfo                 specify a host information");
        l.add(null, " 5 6     <os>                oerating system");
        l.add(null, " 6 .       <cpu>             hardware platform");
        l.add(null, " 4 5   cname                 specify a canonical name");
        l.add(null, " 5 .     <name>              name of host");
        l.add(null, " 4 5   rp                    specify a responsible person");
        l.add(null, " 5 6     <srv>               mail server");
        l.add(null, " 6 .       <email>           email of author");
        l.add(null, " 4 5   srv                   specify a responsible person");
        l.add(null, " 5 6     <pri>               priority");
        l.add(null, " 6 7       <wei>             weight");
        l.add(null, " 7 8         <prt>           port");
        l.add(null, " 8 .           <srv>         server");
        l.add(null, " 4 5   mx                    specify a mailbox server");
        l.add(null, " 5 6     <prf>               preference");
        l.add(null, " 6 .       <srv>             mail server");
        l.add(null, " 4 5   txt                   specify a description");
        l.add(null, " 5 5,.   <text>              description");
        l.add(null, " 4 5   ns                    specify a name server");
        l.add(null, " 5 .     <srv>               name server");
        l.add(null, " 4 5   ptr                   specify a pointer");
        l.add(null, " 5 .     <name>              name of address");
