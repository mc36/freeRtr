...
public class servP4lang extends servGeneric implements prtServS {
    ...
    public final static String[] defaultL = {
        ...
        "server p4lang .*! no export-list4 .*",
        "server p4lang .*! no export-list6 .*",
        "server p4lang .*! no export-map4 .*",
        ...
        "server p4lang .*! no forwarder .* export-list4 .*",
        "server p4lang .*! no forwarder .* export-list6 .*",
        "server p4lang .*! no forwarder .* export-map4 .*",
