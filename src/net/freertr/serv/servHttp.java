...
class servHttpConn implements Runnable {
    ...
    private boolean sendOneDir(String s) {
        ...
        rsp += "</tbody></table><br/><br/>\n";
        rsp += "<table><thead><tr><td><b>extension</b></td><td><b>count</b></td><td><b>bytes</b></td><td><b>smallest</b></td><td><b>biggest</b></td><td><b>oldest</b></td><td><b>newest</b></td></tr></thead><tbody>\n";
        rsp += totalD;
        rsp += totalF;
        for (int i = 0; i < stats.size(); i++) {
            rsp += stats.get(i);
        }
        rsp += "</tbody></table><br/><i>generated by </i><b>" + version.namVer + "</b>.</body></html>\n";
        sendTextHeader("200 ok", "text/html", rsp.getBytes());
        dumpXml(rsp);
        return false;
    }
