...
class servHttpConn implements Runnable {
    ...
    private boolean sendOneDir(String s) {
        ...
        rsp += "</tbody></table><br/>listed " + dirs + " directories and " + fils + " files, using " + lens + " bytes total.<br/>\n";
        rsp += "modified between " + bits.time2str(cfgAll.timeZoneName, minT, 3) + " and " + bits.time2str(cfgAll.timeZoneName, maxT, 3) + ".<br/>\n";
        rsp += "sizes vary between " + minS + " and " + maxS + ".<br/>\n";
