...
public class cryECcurve {
     ...
     * @param mn order
     */
    public cryECcurve(String mna, int[] mo, BigInteger mp, BigInteger ma, BigInteger mb, BigInteger mx, BigInteger my, BigInteger mn) {
        nam = mna;
        oid = mo;
        p = mp;
        a = ma;
    ...
    public static final cryECcurve[] curves = {
        new cryECcurve("nistp112r1", new int[]{0x2b, 0x81, 0x04, 0x00, 6},
        ...
        new cryECcurve("nistp112r2", new int[]{0x2b, 0x81, 0x04, 0x00, 7},
        new BigInteger("DB7C2ABF62E35E668076BEAD208B", 16),
        ...
        new cryECcurve("wtls8", new int[]{2, 23, 43, 1, 4, 8},
        ...
        new cryECcurve("nistp128r1", new int[]{0x2b, 0x81, 0x04, 0x00, 28},
        ...
        new cryECcurve("nistp128r2", new int[]{0x2b, 0x81, 0x04, 0x00, 29},
        new BigInteger("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFF", 16),
        ...
        new cryECcurve("nistp160k1", new int[]{0x2b, 0x81, 0x04, 0x00, 9},
        ...
        new cryECcurve("nistp160r1", new int[]{0x2b, 0x81, 0x04, 0x00, 8},
        ...
        new cryECcurve("nistp160r2", new int[]{0x2b, 0x81, 0x04, 0x00, 30},
        new BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC73", 16),
        ...
        new cryECcurve("wtls9", new int[]{2, 23, 43, 1, 4, 9},
        ...
        new cryECcurve("brainpool160r1", new int[]{1, 3, 36, 3, 3, 2, 8, 1, 1, 1},
        ...
        new cryECcurve("brainpool160t1", new int[]{1, 3, 36, 3, 3, 2, 8, 1, 1, 2},
        new BigInteger("E95E4A5F737059DC60DFC7AD95B3D8139515620F", 16),
        ...
        new BigInteger("E95E4A5F737059DC60DF5991D45029409E60FC09", 16)),
        new cryECcurve("nistp192k1", new int[]{0x2b, 0x81, 0x04, 0x00, 31},
        ...
        new cryECcurve("nistp192r1", new int[]{1, 2, 840, 10045, 1, 1, 1},
        ...
        new cryECcurve("prime192v2", new int[]{1, 2, 840, 10045, 3, 1, 2},
        new BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFF", 16),
        new BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC", 16),
        ...
        new cryECcurve("prime192v3", new int[]{1, 2, 840, 10045, 3, 1, 3},
        new BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFF", 16),
        new BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC", 16),
        ...
        new cryECcurve("brainpool192r1", new int[]{1, 3, 36, 3, 3, 2, 8, 1, 1, 3},
        ...
        new cryECcurve("brainpool192t1", new int[]{1, 3, 36, 3, 3, 2, 8, 1, 1, 4},
        new BigInteger("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297", 16),
        ...
        new BigInteger("C302F41D932A36CDA7A3462F9E9E916B5BE8F1029AC4ACC1", 16)),
        new cryECcurve("nistp224k1", new int[]{0x2b, 0x81, 0x04, 0x00, 31},
        ...
        new cryECcurve("nistp224r1", new int[]{0x2b, 0x81, 0x04, 0x00, 33},
        ...
        new cryECcurve("wtls12", new int[]{2, 23, 43, 1, 4, 12},
        new BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001", 16),
        new BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFE", 16),
        new BigInteger("B4050A850C04B3ABF54132565044B0B7D7BFD8BA270B39432355FFB4", 16),
        new BigInteger("B70E0CBD6BB4BF7F321390B94A03C1D356C21122343280D6115C1D21", 16),
        new BigInteger("bd376388b5f723fb4c22dfe6cd4375a05a07476444d5819985007e34", 16),
        new BigInteger("FFFFFFFFFFFFFFFFFFFFFFFFFFFF16A2E0B8F03E13DD29455C5C2A3D", 16)),
        new cryECcurve("brainpool224r1", new int[]{1, 3, 36, 3, 3, 2, 8, 1, 1, 5},
        ...
        new cryECcurve("brainpool224t1", new int[]{1, 3, 36, 3, 3, 2, 8, 1, 1, 6},
        new BigInteger("D7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FF", 16),
        ...
        new BigInteger("D7C134AA264366862A18302575D0FB98D116BC4B6DDEBCA3A5A7939F", 16)),
        new cryECcurve("prime239v1", new int[]{1, 2, 840, 10045, 3, 1, 4},
        ...
        new cryECcurve("prime239v2", new int[]{1, 2, 840, 10045, 3, 1, 5},
        new BigInteger("7FFFFFFFFFFFFFFFFFFFFFFF7FFFFFFFFFFF8000000000007FFFFFFFFFFF", 16),
        new BigInteger("7FFFFFFFFFFFFFFFFFFFFFFF7FFFFFFFFFFF8000000000007FFFFFFFFFFC", 16),
        ...
        new cryECcurve("prime239v3", new int[]{1, 2, 840, 10045, 3, 1, 6},
        new BigInteger("7FFFFFFFFFFFFFFFFFFFFFFF7FFFFFFFFFFF8000000000007FFFFFFFFFFF", 16),
        new BigInteger("7FFFFFFFFFFFFFFFFFFFFFFF7FFFFFFFFFFF8000000000007FFFFFFFFFFC", 16),
        ...
        new cryECcurve("curve25519", new int[]{1, 3, 6, 1, 4, 1, 3029, 1, 5, 1},
        new BigInteger("7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFED", 16),
        new BigInteger("7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFA2F1F870883D", 16),
        new BigInteger("0000000000000015981AE3C3B2B63780", 16),
        new BigInteger("0000000000591D8C", 16),
        new BigInteger("12E5A073C771A89D1A0A9D84A570989B63B962AC60F26E535D3EC11AFE82C32D", 16),
        new BigInteger("1000000000000000000000000000000014DEF9DEA2F79CD65812631A5CF5D3ED", 16)),
        new cryECcurve("nistp256k1", new int[]{0x2b, 0x81, 0x04, 0x00, 10},
        ...
        new cryECcurve("nistp256r1", new int[]{1, 2, 840, 10045, 1, 1, 7},
        ...
        new cryECcurve("prime256v1", new int[]{1, 2, 840, 10045, 3, 1, 7},
        new BigInteger("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF", 16),
        new BigInteger("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC", 16),
        new BigInteger("5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B", 16),
        new BigInteger("6B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C296", 16),
        new BigInteger("4fe342e2fe1a7f9b8ee7eb4a7c0f9e162bce33576b315ececbb6406837bf51f5", 16),
        new BigInteger("FFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551", 16)),
        new cryECcurve("brainpool256r1", new int[]{1, 3, 36, 3, 3, 2, 8, 1, 1, 7},
        ...
        new cryECcurve("brainpool256t1", new int[]{1, 3, 36, 3, 3, 2, 8, 1, 1, 8},
        new BigInteger("A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377", 16),
        ...
        new BigInteger("A9FB57DBA1EEA9BC3E660A909D838D718C397AA3B561A6F7901E0E82974856A7", 16)),
        new cryECcurve("brainpool320r1", new int[]{1, 3, 36, 3, 3, 2, 8, 1, 1, 9},
        ...
        new cryECcurve("brainpool320t1", new int[]{1, 3, 36, 3, 3, 2, 8, 1, 1, 10},
        new BigInteger("D35E472036BC4FB7E13C785ED201E065F98FCFA6F6F40DEF4F92B9EC7893EC28FCD412B1F1B32E27", 16),
        ...
        new BigInteger("D35E472036BC4FB7E13C785ED201E065F98FCFA5B68F12A32D482EC7EE8658E98691555B44C59311", 16)),
        new cryECcurve("nistp384r1", new int[]{0x2b, 0x81, 0x04, 0x00, 34},
        ...
        new cryECcurve("brainpool384r1", new int[]{1, 3, 36, 3, 3, 2, 8, 1, 1, 11},
        ...
        new cryECcurve("brainpool384t1", new int[]{1, 3, 36, 3, 3, 2, 8, 1, 1, 12},
        new BigInteger("8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B412B1DA197FB71123ACD3A729901D1A71874700133107EC53", 16),
        ...
        new BigInteger("8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B31F166E6CAC0425A7CF3AB6AF6B7FC3103B883202E9046565", 16)),
        new cryECcurve("brainpool512r1", new int[]{1, 3, 36, 3, 3, 2, 8, 1, 1, 13},
        ...
        new cryECcurve("brainpool512t1", new int[]{1, 3, 36, 3, 3, 2, 8, 1, 1, 14},
        new BigInteger("AADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA703308717D4D9B009BC66842AECDA12AE6A380E62881FF2F2D82C68528AA6056583A48F3", 16),
        ...
        new BigInteger("AADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA70330870553E5C414CA92619418661197FAC10471DB1D381085DDADDB58796829CA90069", 16)),
        new cryECcurve("nistp521r1", new int[]{0x2b, 0x81, 0x04, 0x00, 35},
