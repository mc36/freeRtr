...
java -Xmx512m -jar rtr.jar test tester - summary slot 1 retry 8 paralell 10 mem 4096 openjdk11 param -javaagent:jacocoagent.jar=output=file,destfile=../binTmp/%fn%-%rn%.jacoco $@
